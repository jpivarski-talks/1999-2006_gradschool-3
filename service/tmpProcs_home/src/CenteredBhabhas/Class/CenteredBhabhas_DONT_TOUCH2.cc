...
// Module:      CenteredBhabhas_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor CenteredBhabhas:
//              creates a new CenteredBhabhas instance each time 

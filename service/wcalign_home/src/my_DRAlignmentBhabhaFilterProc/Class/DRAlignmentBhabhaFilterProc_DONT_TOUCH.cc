...
// $Id: DRAlignmentBhabhaFilterProc_DONT_TOUCH.cc,v 1.1.1.1 2003/12/05 17:54:58 mccann Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: DRAlignmentBhabhaFilterProc_DONT_TOUCH.cc,v 1.1.1.1 2003/12/05 17:54:58 mccann Exp $";

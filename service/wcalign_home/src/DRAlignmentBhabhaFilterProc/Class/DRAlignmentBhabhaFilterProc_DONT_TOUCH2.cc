...
// $Id: DRAlignmentBhabhaFilterProc_DONT_TOUCH2.cc,v 1.1.1.1 2003/12/15 18:45:14 mccann Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: DRAlignmentBhabhaFilterProc_DONT_TOUCH2.cc,v 1.1.1.1 2003/12/15 18:45:14 mccann Exp $";

...
//
// Author:      Jim McCann
// Created:     Tue Apr  9 16:45:04 EDT 2002
// $Id$
//
// Revision history
//
...
//
static const char* const kFacilityString = "Processor.CakeAlign" ;
...
//
CakeAlign::CakeAlign( void )               // anal1
   : Processor( "CakeAlign" )
{
   ...
   bind( &CakeAlign::event,    Stream::kEvent );
   //bind( &CakeAlign::beginRun, Stream::kBeginRun );
   //bind( &CakeAlign::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
CakeAlign::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
CakeAlign::terminate( void )     // anal5 "Interactive"
{
...
void
CakeAlign::hist_book( HIHistoManager& iHistoManager )
{
...
CakeAlign::event( Frame& iFrame )          // anal3 equiv.
{
...
/*
ActionBase::ActionResult
CakeAlign::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
CakeAlign::endRun( Frame& iFrame )         // anal4 equiv.
{

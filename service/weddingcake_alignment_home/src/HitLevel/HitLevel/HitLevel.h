...
class HitLevel : public Processor
{
   ...
   private:
      ...
      HIHist2D* m_event_momentum_2d;
      HIHist1D* m_event_momentum_x;
      HIHist1D* m_event_momentum_y;
      HIHist1D* m_event_momentum_z;
      HIHistProf* m_momentum_vs_phi0;
      HIHistProf* m_momentum_vs_phi0_subtracted;

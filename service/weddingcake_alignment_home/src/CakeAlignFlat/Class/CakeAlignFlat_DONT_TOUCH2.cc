...
// Module:      CakeAlignFlat_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor CakeAlignFlat:
//              creates a new CakeAlignFlat instance each time 

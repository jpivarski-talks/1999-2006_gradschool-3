...
// Module:      CakeAlignFast_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor CakeAlignFast:
//              creates a new CakeAlignFast instance each time 

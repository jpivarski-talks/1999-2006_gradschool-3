...
//
// Author:      Jim McCann
// Created:     Tue May 14 16:25:11 EDT 2002
// $Id$
//
// Revision history
//
...
// user include files
#include "CakeAlignFast/CakeAlignFast.h"
...
//
static const char* const kFacilityString = "Processor.CakeAlignFast" ;
...
//
CakeAlignFast::CakeAlignFast( void )               // anal1
   : Processor( "CakeAlignFast" )
{
   ...
   bind( &CakeAlignFast::event,    Stream::kEvent );
   //bind( &CakeAlignFast::beginRun, Stream::kBeginRun );
   //bind( &CakeAlignFast::endRun,   Stream::kEndRun );
...
CakeAlignFast::~CakeAlignFast()                    // anal5
{
...
// --------------------------- init method -------------------------
void
CakeAlignFast::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
CakeAlignFast::terminate( void )     // anal5 "Interactive"
{
...
void
CakeAlignFast::hist_book( HIHistoManager& iHistoManager )
{
...
CakeAlignFast::event( Frame& iFrame )          // anal3 equiv.
{
   ...
   if ( seedtracks.size() != 2 ) return ActionBase::kPassed; // ActionBase::kFailed;
   ...
   for ( FATable< TRSeedTrack >::const_iterator seed_iter = seedtracks.begin();
	 ...
	 seed_iter++ ) {
      ...
      else return ActionBase::kPassed; // ActionBase::kFailed;
...
/*
ActionBase::ActionResult
CakeAlignFast::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
CakeAlignFast::endRun( Frame& iFrame )         // anal4 equiv.
{

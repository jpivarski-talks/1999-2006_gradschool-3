...
// $Id: NavTrack_trackShowerMatch.cc,v 1.1 2000/04/05 15:43:04 marsh Exp $
//
// Revision history
//
// $Log: NavTrack_trackShowerMatch.cc,v $
...
FAItem< NavTkShMatch >
NavTrack::trackShowerMatch() const
{
   return FAItem< NavTkShMatch >( m_master.trackShowerMatch( identifier() ) );
}

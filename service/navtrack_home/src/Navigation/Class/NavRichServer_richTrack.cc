...
// $Id: NavRichServer_richTrack.cc,v 1.1 2000/11/20 00:05:52 ts Exp $
//
// Revision history
//
// $Log: NavRichServer_richTrack.cc,v $
// Revision 1.1  2000/11/20 00:05:52  ts
...
NAVRICHSER( RichTrack , richTrack , m_RichTrack );

...
// $Id: NavRichServer_trackPhotons.cc,v 1.1 2000/07/27 01:31:40 ts Exp $
//
// Revision history
//
// $Log: NavRichServer_trackPhotons.cc,v $
...
NAVRICHSER( RichTrackPhotons , richTrackPhotons , m_RichTrackPhotons );

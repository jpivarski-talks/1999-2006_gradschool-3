...
// $Id: STL_vector_of_SeedDRHitLink.cc,v 1.2 1999/04/23 21:35:39 marsh Exp $
//
// Revision history
//
// $Log: STL_vector_of_SeedDRHitLink.cc,v $
// Revision 1.2  1999/04/23 21:35:39  marsh
...
typedef const SeedTrackDRHitLattice::Link* _vector_contents_ ;

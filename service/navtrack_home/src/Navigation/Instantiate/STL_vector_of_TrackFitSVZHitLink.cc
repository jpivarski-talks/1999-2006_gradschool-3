...
//
// Package:     Navigation
// Module:      STL_vector_of_TrackFitSVZHitLink
// 
...
// $Id: STL_vector_of_TrackFitSVZHitLink.cc,v 1.3 1999/06/25 17:28:51 pg Exp $
//
// Revision history
//
// $Log: STL_vector_of_TrackFitSVZHitLink.cc,v $
...
typedef const NavTrack::SVZHitLink* _vector_contents_ ;

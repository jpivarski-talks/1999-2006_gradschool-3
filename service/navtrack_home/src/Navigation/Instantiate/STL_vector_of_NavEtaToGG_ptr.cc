...
// $Id: STL_vector_of_NavEtaToGG_ptr.cc,v 1.1 2001/12/13 20:54:24 bkh Exp $
//
// Revision history
//
// $Log: STL_vector_of_NavEtaToGG_ptr.cc,v $
// Revision 1.1  2001/12/13 20:54:24  bkh
...
typedef const NavEtaToGG* _vector_contents_ ;

...
// $Id: STL_vector_of_SeedSVZHitLink.cc,v 1.1 1999/04/23 21:35:41 marsh Exp $
//
// Revision history
//
// $Log: STL_vector_of_SeedSVZHitLink.cc,v $
// Revision 1.1  1999/04/23 21:35:41  marsh
...
typedef const SeedTrackSVZHitLattice::Link* _vector_contents_ ;

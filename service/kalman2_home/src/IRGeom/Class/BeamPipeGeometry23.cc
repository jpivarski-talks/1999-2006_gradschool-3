...
// $Id: BeamPipeGeometry23.cc,v 1.4 2002/05/31 17:19:45 bkh Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: BeamPipeGeometry23.cc,v 1.4 2002/05/31 17:19:45 bkh Exp $";

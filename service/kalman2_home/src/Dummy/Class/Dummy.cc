...
//
static const char* const kFacilityString = "Processor.Dummy" ;
   ...
   : Processor( "Dummy" )
{
   ...
   bind( &Dummy::event,    Stream::kEvent );
   //bind( &Dummy::beginRun, Stream::kBeginRun );
   //bind( &Dummy::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
Dummy::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
Dummy::terminate( void )     // anal5 "Interactive"
{
...
void
Dummy::hist_book( HIHistoManager& iHistoManager )
{
...
Dummy::event( Frame& iFrame )          // anal3 equiv.
{
...
/*
ActionBase::ActionResult
Dummy::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
Dummy::endRun( Frame& iFrame )         // anal4 equiv.
{

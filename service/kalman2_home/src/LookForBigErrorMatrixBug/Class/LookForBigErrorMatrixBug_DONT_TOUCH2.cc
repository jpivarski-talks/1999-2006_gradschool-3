...
// Module:      LookForBigErrorMatrixBug_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor LookForBigErrorMatrixBug:
//              creates a new LookForBigErrorMatrixBug instance each time 
...
makeProcessor( void )
{
   return new LookForBigErrorMatrixBug;
}

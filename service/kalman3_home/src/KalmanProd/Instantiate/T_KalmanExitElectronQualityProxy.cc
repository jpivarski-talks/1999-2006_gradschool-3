...
//
// Package:     KalmanProd
// Module:      T_KalmanExitElectronQualityProxy
// 
...
// $Id: T_KalmanExitElectronQualityProxy.cc,v 1.2 2000/08/16 20:18:25 wsun Exp $
//
// Revision history
//
// $Log: T_KalmanExitElectronQualityProxy.cc,v $
...
#include "KalmanFilter/KalmanExitElectronQuality.h"
...
//typedef KalmanCandidateQuality< DBCandidate::kExitElectron > KalmanExitElectronQuality;
template class KalmanCandidateQualityProxy< DBCandidate::kExitElectron > ;

// #include "FrameAccess/instantiate_macros.h"
// INSTANTIATE_MANY( KalmanExitElectronQuality )

...
// $Id: TRTrackCandidateFitQualityStorageHelper.cc,v 1.10 2001/01/05 05:27:39 lyon Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: TRTrackCandidateFitQualityStorageHelper.cc,v 1.10 2001/01/05 05:27:39 lyon Exp $";

...
// $Id: TRHelixCandidateFitStorageHelper.cc,v 1.2 2000/06/16 02:49:03 marsh Exp $
//
// Revision history
//
...
//static const char* const kIdString  = "$Id: TRHelixCandidateFitStorageHelper.cc,v 1.2 2000/06/16 02:49:03 marsh Exp $";
...
TRHelixCandidateFitStorageHelper<H>::deliverV1( SMSourceStream& iSource )
{
   ...
   return make( TRHelixCandidateFit<H>( 
				       identifier,  
				       KTHelix( curvature,  
						phi0,  
						d0,  

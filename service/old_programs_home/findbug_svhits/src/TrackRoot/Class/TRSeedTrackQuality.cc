...
// $Id: TRSeedTrackQuality.cc,v 1.3 2001/01/05 05:27:31 lyon Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: TRSeedTrackQuality.cc,v 1.3 2001/01/05 05:27:31 lyon Exp $";

...
// 
// Description: Instantiate TRHelixCandidateFit< kChargedKaon >
//
// Implimentation:
...
// $Id: T_TRHelixKaonFitStorageHelper.cc,v 1.1 2000/01/05 18:47:06 cdj Exp $
//
// Revision history
//
// $Log: T_TRHelixKaonFitStorageHelper.cc,v $
...
INSTANTIATE_HELIX_STORE(DBCandidate::kChargedKaon,Kaon)

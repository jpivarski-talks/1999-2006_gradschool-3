...
// $Id: T_TRHelixExitElectronFitStorageHelper.cc,v 1.1 2000/01/05 18:47:02 cdj Exp $
//
// Revision history
//
// $Log: T_TRHelixExitElectronFitStorageHelper.cc,v $
...
INSTANTIATE_HELIX_STORE(DBCandidate::kExitElectron, ExitElectron)

...
// 
// Description: Instantiate TRTrackCandidateFitQuality< kMuon >
//
// Implimentation:
...
// $Id: T_TRTrackMuonFitQuality.cc,v 1.1 1998/12/18 19:37:15 marsh Exp $
//
// Revision history
//
// $Log: T_TRTrackMuonFitQuality.cc,v $
...
// for AXP
#pragma define_template TRTrackCandidateFitQuality< DBCandidate::kMuon >
#else
template class TRTrackCandidateFitQuality< DBCandidate::kMuon > ;

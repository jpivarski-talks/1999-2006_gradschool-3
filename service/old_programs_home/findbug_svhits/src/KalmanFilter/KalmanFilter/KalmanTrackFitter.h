...
// $Id: KalmanTrackFitter.h,v 1.28 2001/03/27 06:39:41 wsun Exp $
//
// Revision history
//
...
class KalmanTrackFitter : public TrackFitter
{
   ...
   public:
	 ...
	 FitDirection aDirection,
      ...
      void setOutwardFitIsInwardSeed( DABoolean aFlag )
      { m_outwardFitIsInwardSeed = aFlag ; }
	 ...
	 m_cathodeFittingWeightScale = aScale ;
      ...
      virtual DABoolean outwardFitIsInwardSeed() const
      { return m_outwardFitIsInwardSeed ; }
   ...
   private:
	 ...
	 const ;
      ...
      KalmanHelix* m_outwardFit ;

      DABoolean m_outwardFitIsInwardSeed ;

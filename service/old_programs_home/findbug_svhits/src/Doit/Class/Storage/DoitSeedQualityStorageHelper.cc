...
// $Id: DoitSeedQualityStorageHelper.cc,v 1.6 2001/01/05 06:30:27 lyon Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: DoitSeedQualityStorageHelper.cc,v 1.6 2001/01/05 06:30:27 lyon Exp $";

...
// $Id: DoitStatusInfo.cc,v 1.2 2001/01/05 06:30:22 lyon Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: DoitStatusInfo.cc,v 1.2 2001/01/05 06:30:22 lyon Exp $";
...
void DoitStatusInfo::printout(ostream& s) const
{
  ...
  reportFlag( s, "used_tfxfitlfw_with_z0_constraint",

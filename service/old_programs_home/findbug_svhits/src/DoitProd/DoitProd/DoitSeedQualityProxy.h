#if !defined(DOITPROD_DOITSEEDQUALITYPROXY_H)
#define DOITPROD_DOITSEEDQUALITYPROXY_H
// -*- C++ -*-
//
// Package:     <DoitProd>
...
// $Id: DoitSeedQualityProxy.h,v 1.1.1.1 1999/09/08 18:53:32 lyon Exp $
//
// Revision history
//
// $Log: DoitSeedQualityProxy.h,v $
...
#endif /* DOITPROD_DOITSEEDQUALITYPROXY_H */

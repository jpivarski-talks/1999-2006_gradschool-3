...
// $Id: LatticeLinkTrackFitDRHitLatticeStorageHelper.cc,v 1.10 2001/09/26 08:01:26 wsun Exp $
//
// Revision history
//
...
static const char* const kSMIdString  = "$Id: LatticeLinkTrackFitDRHitLatticeStorageHelper.cc,v 1.10 2001/09/26 08:01:26 wsun Exp $";
...
LatticeLinkTrackFitDRHitLatticeStorageHelper<H>::implementStore( 
   ...
   const SMLatticeLinkInfoBase<
      LatticeLinkTrackFitDRHitLatticeStorageHelper<H>::TrackFitDRHitLattice >&
      iData ) 
{

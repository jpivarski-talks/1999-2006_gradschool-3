...
// $Id: TrackFitDRHitLink.cc,v 1.14 2001/09/26 08:01:15 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: TrackFitDRHitLink.cc,v 1.14 2001/09/26 08:01:15 wsun Exp $";
...
TrackFitDRHitLink::TrackFitDRHitLink( DABoolean used,
                                      double residual,
                                      double resError,
                                      double momentum,
                                      const HepPoint3D& aSpacePoint,
				      Meters aSignedDcaToWire,
				      Meters aSignedDcaError,
				      double aSinTrackToRadial,
   ...
   m_trackRefPt(       aSpacePoint ),
   m_dca(              aSignedDcaToWire ),
   m_dcaError(         aSignedDcaError ),
   m_sinTrackToRadial( aSinTrackToRadial ),
...
TrackFitDRHitLink::TrackFitDRHitLink( const TrackFitDRHitLink& rhs )
   : TrackFitHitLink( rhs ),
...
const TrackFitDRHitLink& TrackFitDRHitLink::operator=(
   const TrackFitDRHitLink& rhs )
{
   if( this != &rhs )
   {

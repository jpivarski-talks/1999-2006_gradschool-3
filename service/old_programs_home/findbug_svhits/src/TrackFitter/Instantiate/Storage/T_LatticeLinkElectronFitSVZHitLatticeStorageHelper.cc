...
//
// Package:     <TrackFitter>
// Module:      LatticeElectronFitSVZHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkElectronFitSVZHitLatticeStorageHelper.cc,v 1.1 2000/02/24 17:28:53 wsun Exp $
//
// Revision history
//
// $Log: T_LatticeLinkElectronFitSVZHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kElectron,Electron,SVZ)

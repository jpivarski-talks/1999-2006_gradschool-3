...
//
// Package:     <TrackFitter>
// Module:      LatticeProtonFitDRHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkProtonFitDRHitLatticeStorageHelper.cc,v 1.1 2000/02/24 17:29:16 wsun Exp $
//
// Revision history
//
// $Log: T_LatticeLinkProtonFitDRHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kProton,Proton,DR)

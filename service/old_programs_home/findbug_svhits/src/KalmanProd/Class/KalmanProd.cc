...
// $Id: KalmanProd.cc,v 1.12 2000/12/13 07:04:15 wsun Exp $
//
// Revision history
//
// $Log: KalmanProd.cc,v $
...
static const char* const kIdString  = "$Id: KalmanProd.cc,v 1.12 2000/12/13 07:04:15 wsun Exp $";
...
KalmanProd::KalmanProd( void )               // anal1
   : Producer(                 "KalmanProd" ),
     ...
     m_outwardFitIsInwardSeed( "OutwardFitIsInwardSeed", this, false ),

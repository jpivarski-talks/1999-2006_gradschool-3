...
// $Id: KalmanTrackFitterProxy.cc,v 1.14 2001/02/26 16:49:16 cdj Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanTrackFitterProxy.cc,v 1.14 2001/02/26 16:49:16 cdj Exp $";
...
//   assert( 0 == m_kalmanTrackFitter );
   ...
   m_kalmanTrackFitter->setOutwardFitIsInwardSeed(
      m_kalmanProd->outwardFitIsInwardSeed() ||

...
// $Id: KalmanProd.h,v 1.12 2000/12/13 07:04:19 wsun Exp $
//
// Revision history
//
// $Log: KalmanProd.h,v $
...
class KalmanProd : public Producer
{
   ...
   public:
      ...
      DABoolean outwardFitIsInwardSeed() const
      { return m_outwardFitIsInwardSeed.value() ; }
   ...
   private:
      ...
      Parameter< DABoolean > m_outwardFitIsInwardSeed ;

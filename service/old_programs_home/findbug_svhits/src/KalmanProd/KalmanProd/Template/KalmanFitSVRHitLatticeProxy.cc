...
// $Id: KalmanFitSVRHitLatticeProxy.cc,v 1.5 2001/03/27 06:43:04 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanFitSVRHitLatticeProxy.cc,v 1.5 2001/03/27 06:43:04 wsun Exp $";
...
template < DBCandidate::Hypo H >
#endif
const KalmanFitSVRHitLatticeProxy< H >::value_type*

...
// $Id: KalmanFitSVZHitLatticeProxy.cc,v 1.5 2001/03/27 06:43:05 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanFitSVZHitLatticeProxy.cc,v 1.5 2001/03/27 06:43:05 wsun Exp $";
...
template < DBCandidate::Hypo H >
#endif
const KalmanFitSVZHitLatticeProxy< H >::value_type*

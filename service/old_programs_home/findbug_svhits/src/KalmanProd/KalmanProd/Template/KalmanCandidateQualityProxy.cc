...
// $Id: KalmanCandidateQualityProxy.cc,v 1.8 2001/03/27 06:43:02 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanCandidateQualityProxy.cc,v 1.8 2001/03/27 06:43:02 wsun Exp $";
...
template < DBCandidate::Hypo H >
#endif
const KalmanCandidateQualityProxy< H >::value_type*

...
// $Id: KalmanFitDRHitLatticeProxy.cc,v 1.5 2001/03/27 06:43:03 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanFitDRHitLatticeProxy.cc,v 1.5 2001/03/27 06:43:03 wsun Exp $";
...
template < DBCandidate::Hypo H >
#endif
const KalmanFitDRHitLatticeProxy< H >::value_type*

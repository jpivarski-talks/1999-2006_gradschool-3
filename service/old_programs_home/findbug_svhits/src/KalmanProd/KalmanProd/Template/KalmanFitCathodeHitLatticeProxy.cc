...
// $Id: KalmanFitCathodeHitLatticeProxy.cc,v 1.5 2001/03/27 06:43:02 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanFitCathodeHitLatticeProxy.cc,v 1.5 2001/03/27 06:43:02 wsun Exp $";
...
template < DBCandidate::Hypo H >
#endif
const KalmanFitCathodeHitLatticeProxy< H >::value_type*

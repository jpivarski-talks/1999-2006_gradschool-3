...
// $Id: HIMSDedxOperation.cc,v 1.6 2001/08/23 16:52:08 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: HIMSDedxOperation.cc,v 1.6 2001/08/23 16:52:08 wsun Exp $";
...
//    }
	 ...
	 m_modifyHelixParametersForMS ) )
   {
	 ...
	 cout << "beta new/old " << newBeta
	      << "/" << absmom*absmom/betaInvAbsmomInv

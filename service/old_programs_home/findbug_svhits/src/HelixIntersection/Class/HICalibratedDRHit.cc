...
// $Id: HICalibratedDRHit.cc,v 1.8 2001/09/26 08:03:49 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: HICalibratedDRHit.cc,v 1.8 2001/09/26 08:03:49 wsun Exp $";
...
HICalibratedDRHit::applyTrackCorrections( const HIHelix& aHelix )
{
   ...
   m_hitCorrector->correctDriftTimeAndDist( aHelix,
					    *m_hit,
					    aHelix.mass(),
					    m_signedDriftDistance,
					    m_averageChargeOnTrack,
					    m_driftTime,
					    correctedSignedDist,
					    correctedResolution ) ;

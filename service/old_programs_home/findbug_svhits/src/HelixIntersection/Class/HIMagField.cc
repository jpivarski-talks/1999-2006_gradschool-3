...
// $Id: HIMagField.cc,v 1.2 1999/06/30 22:19:05 wsun Exp $
//
// Revision history
//
// $Log: HIMagField.cc,v $
...
static const char* const kIdString  = "$Id: HIMagField.cc,v 1.2 1999/06/30 22:19:05 wsun Exp $";
...
HIMagField::bfield( const HepPoint3D& position ) const
{
   if( m_useFrameField )
   {
      ...
      {
	 return m_magneticField->BField( position ) ;
      }
      else
      {

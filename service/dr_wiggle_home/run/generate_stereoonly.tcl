...
file sink ../rzn/stereoonly$env(USER_N).pds {event {FATable<TRTrack> FATable<TRHelixPionFit> PionFitDRHitLattice PionFitSVRHitLattice PionFitSVZHitLattice FATable<CalibratedSVRphiHit> FATable<CalibratedSVZHit> FATable<DualTrackHelices>}}

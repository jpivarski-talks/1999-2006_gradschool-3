...
// Module:      WheresTheBeamspot_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor WheresTheBeamspot:
//              creates a new WheresTheBeamspot instance each time 

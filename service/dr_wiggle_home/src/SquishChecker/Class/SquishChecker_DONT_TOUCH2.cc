...
// Module:      SquishChecker_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor SquishChecker:
//              creates a new SquishChecker instance each time 

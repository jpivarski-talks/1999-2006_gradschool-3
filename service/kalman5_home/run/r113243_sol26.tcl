...
file source ../pds/r113243.pds event

sink_format sel PDSSinkFormat
file sink ../pds/r113243_sol26.pds {event {FATable<TRTrack> FATable<TRHelixExitPionFit> FATable<TRHelixPionFit> FATable<TRExitPionQuality> FATable<TRPionQuality> FATable<TRHelixExitKaonFit> FATable<TRHelixKaonFit> FATable<TRExitKaonQuality> FATable<TRKaonQuality> FATable<TRHelixExitProtonFit> FATable<TRHelixProtonFit> FATable<TRExitProtonQuality> FATable<TRProtonQuality> FATable<TRSeedTrackQuality> FATable<TRSeedTrack>}}

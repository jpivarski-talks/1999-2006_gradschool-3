...
file sink ../pds/r113244_sol8.pds {event {FATable<TRTrack> FATable<TRHelixExitPionFit> FATable<TRHelixPionFit> FATable<TRExitPionQuality> FATable<TRPionQuality> FATable<TRHelixExitKaonFit> FATable<TRHelixKaonFit> FATable<TRExitKaonQuality> FATable<TRKaonQuality> FATable<TRHelixExitProtonFit> FATable<TRHelixProtonFit> FATable<TRExitProtonQuality> FATable<TRProtonQuality> FATable<TRSeedTrackQuality> FATable<TRSeedTrack>}}

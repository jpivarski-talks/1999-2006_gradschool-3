...
file source ../pds/r123418.pds event

sink_format sel PDSSinkFormat
file sink ../pds/r123418_sol26.pds {event {FATable<TRTrack> FATable<TRHelixExitPionFit> FATable<TRHelixPionFit> FATable<TRExitPionQuality> FATable<TRPionQuality> FATable<TRHelixExitKaonFit> FATable<TRHelixKaonFit> FATable<TRExitKaonQuality> FATable<TRKaonQuality> FATable<TRHelixExitProtonFit> FATable<TRHelixProtonFit> FATable<TRExitProtonQuality> FATable<TRProtonQuality> FATable<TRSeedTrackQuality> FATable<TRSeedTrack>}}

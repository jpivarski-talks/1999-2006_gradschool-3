...
file sink ../pds/r114141_sol8_pd.pds {event {FATable<TRTrack> FATable<TRHelixExitPionFit> FATable<TRHelixPionFit> FATable<TRExitPionQuality> FATable<TRPionQuality> FATable<TRHelixExitKaonFit> FATable<TRHelixKaonFit> FATable<TRExitKaonQuality> FATable<TRKaonQuality> FATable<TRHelixExitProtonFit> FATable<TRHelixProtonFit> FATable<TRExitProtonQuality> FATable<TRProtonQuality> FATable<TRSeedTrackQuality> FATable<TRSeedTrack>}}

...
// Module:      CompareInOutChi2_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor CompareInOutChi2:
//              creates a new CompareInOutChi2 instance each time 

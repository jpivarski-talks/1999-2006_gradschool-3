...
// $Id: HICalibratedSVHit.h,v 1.4 2002/04/27 17:22:29 cleo3 Exp $
//
// Revision history
//
...
class HICalibratedSVHit : public HICalibratedHit
{
   ...
   private:
      ...
      STL_DEQUE( TrackFitSVRHitLink ) m_vectorOfSVRLinkData ;
      STL_DEQUE( TrackFitSVZHitLink ) m_vectorOfSVZLinkData ;

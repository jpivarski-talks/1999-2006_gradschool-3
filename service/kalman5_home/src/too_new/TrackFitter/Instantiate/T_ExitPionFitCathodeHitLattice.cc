...
//
// Package:     TrackFitter
// Module:      T_ExitPionFitCathodeHitLattice
// 
// Description: Template instantiation of FAItem< ExitPionFitCathodeHitLattice>
//
// Implementation:
...
// $Id: T_ExitPionFitCathodeHitLattice.cc,v 1.2 2000/02/24 17:38:24 wsun Exp $
//
// Revision history
//
// $Log: T_ExitPionFitCathodeHitLattice.cc,v $
...
INSTANTIATE_ONE( ExitPionFitCathodeHitLattice )
...
INSTANTIATESTORE_TRACKHITLATTICE(ExitPion,Cathode)

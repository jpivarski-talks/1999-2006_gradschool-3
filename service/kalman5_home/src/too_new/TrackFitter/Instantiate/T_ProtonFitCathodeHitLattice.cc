...
//
// Package:     TrackFitter
// Module:      T_ProtonFitCathodeHitLattice
// 
// Description: Template instantiation of FAItem< ProtonFitCathodeHitLattice >
//
// Implementation:
...
// $Id: T_ProtonFitCathodeHitLattice.cc,v 1.2 2000/02/24 17:38:33 wsun Exp $
//
// Revision history
//
// $Log: T_ProtonFitCathodeHitLattice.cc,v $
...
INSTANTIATE_ONE( ProtonFitCathodeHitLattice )
...
INSTANTIATESTORE_TRACKHITLATTICE(Proton,Cathode)

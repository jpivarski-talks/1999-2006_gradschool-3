...
// 
// Description: Template instantiation of FAItem< PionFitDRHitLattice >
//
// Implementation:
...
// $Id: T_PionFitDRHitLattice.cc,v 1.2 2000/02/24 17:38:31 wsun Exp $
//
// Revision history
//
// $Log: T_PionFitDRHitLattice.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICE(Pion,DR)

...
// 
// Description: Template instantiation of FAItem< MuonFitZDHitLattice >
//
// Implementation:
...
// $Id: T_MuonFitZDHitLattice.cc,v 1.1 2003/04/17 17:03:19 bkh Exp $
//
// Revision history
//
// $Log: T_MuonFitZDHitLattice.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICE(Muon,ZD)

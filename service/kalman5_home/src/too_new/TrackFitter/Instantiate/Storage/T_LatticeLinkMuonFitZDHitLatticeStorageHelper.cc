...
//
// Package:     <TrackFitter>
// Module:      LatticeMuonFitZDHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkMuonFitZDHitLatticeStorageHelper.cc,v 1.1 2003/04/17 17:03:28 bkh Exp $
//
// Revision history
//
// $Log: T_LatticeLinkMuonFitZDHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kMuon,Muon,ZD)

...
//
// Package:     <TrackFitter>
// Module:      LatticeExitPionFitZDHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkExitPionFitZDHitLatticeStorageHelper.cc,v 1.1 2003/04/17 17:03:27 bkh Exp $
//
// Revision history
//
// $Log: T_LatticeLinkExitPionFitZDHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kExitPion,ExitPion,ZD)

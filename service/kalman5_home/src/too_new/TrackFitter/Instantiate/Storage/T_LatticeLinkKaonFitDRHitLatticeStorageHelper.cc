...
//
// Package:     <TrackFitter>
// Module:      LatticeKaonFitDRHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkKaonFitDRHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:10 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkKaonFitDRHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kChargedKaon,Kaon,DR)

...
//
// Package:     <TrackFitter>
// Module:      LatticeExitPionFitSVZHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkExitPionFitSVZHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:08 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkExitPionFitSVZHitLatticeStorageHelper.cc,v $
// Revision 1.3  2002/06/15 01:59:08  cdj
// fixed template instantiation problem with new code on Solaris 2.6
//
// Revision 1.2  2002/02/14 20:06:42  cleo3
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kExitPion,ExitPion,SVZ)

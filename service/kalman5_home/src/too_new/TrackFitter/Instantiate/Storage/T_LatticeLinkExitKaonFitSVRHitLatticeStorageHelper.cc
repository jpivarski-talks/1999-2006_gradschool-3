...
//
// Package:     <TrackFitter>
// Module:      LatticeExitKaonFitSVRHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkExitKaonFitSVRHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:05 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkExitKaonFitSVRHitLatticeStorageHelper.cc,v $
// Revision 1.3  2002/06/15 01:59:05  cdj
// fixed template instantiation problem with new code on Solaris 2.6
//
// Revision 1.2  2002/02/14 20:06:38  cleo3
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kExitKaon,ExitKaon,SVR)

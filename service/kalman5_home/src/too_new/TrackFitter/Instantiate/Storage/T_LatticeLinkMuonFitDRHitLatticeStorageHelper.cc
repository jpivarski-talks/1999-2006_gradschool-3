...
//
// Package:     <TrackFitter>
// Module:      LatticeMuonFitDRHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkMuonFitDRHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:11 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkMuonFitDRHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kMuon,Muon,DR)

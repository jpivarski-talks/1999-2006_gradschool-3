...
//
// Package:     <TrackFitter>
// Module:      LatticeExitElectronFitSVRHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkExitElectronFitSVRHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:04 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkExitElectronFitSVRHitLatticeStorageHelper.cc,v $
// Revision 1.3  2002/06/15 01:59:04  cdj
// fixed template instantiation problem with new code on Solaris 2.6
//
// Revision 1.2  2002/02/14 20:06:35  cleo3
// changed needed for Solaris8
//
// Revision 1.1  2000/02/24 17:28:56  wsun
// First submission.
//
//
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kExitElectron,ExitElectron,SVR)

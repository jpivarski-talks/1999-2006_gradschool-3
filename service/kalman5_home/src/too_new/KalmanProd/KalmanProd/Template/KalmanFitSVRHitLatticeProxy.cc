...
// $Id: KalmanFitSVRHitLatticeProxy.cc,v 1.7 2003/04/17 17:05:12 bkh Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanFitSVRHitLatticeProxy.cc,v 1.7 2003/04/17 17:05:12 bkh Exp $";

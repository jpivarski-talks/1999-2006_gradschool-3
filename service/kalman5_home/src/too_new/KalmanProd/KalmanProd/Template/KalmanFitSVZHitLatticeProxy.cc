...
// $Id: KalmanFitSVZHitLatticeProxy.cc,v 1.7 2003/04/17 17:05:13 bkh Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanFitSVZHitLatticeProxy.cc,v 1.7 2003/04/17 17:05:13 bkh Exp $";

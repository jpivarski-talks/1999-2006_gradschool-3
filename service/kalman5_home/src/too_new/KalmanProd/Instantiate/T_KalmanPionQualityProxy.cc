...
//
// Package:     KalmanProd
// Module:      T_KalmanChargedPionQualityProxy
// 
...
// $Id: T_KalmanPionQualityProxy.cc,v 1.2 2000/08/16 20:18:28 wsun Exp $
//
// Revision history
//
// $Log: T_KalmanPionQualityProxy.cc,v $
...
//typedef KalmanCandidateQuality< DBCandidate::kChargedPion > KalmanPionQuality;
template class KalmanCandidateQualityProxy< DBCandidate::kChargedPion > ;

// #include "FrameAccess/instantiate_macros.h"
// INSTANTIATE_MANY( KalmanPionQuality )

...
// $Id: HICathodeCylinder.cc,v 1.13 2003/05/30 15:09:37 mccann Exp $
//
// Revision history
//
// $Log: HICathodeCylinder.cc,v $
// Revision 1.13  2003/05/30 15:09:37  mccann
// Cathode fittingweight should be a double, not a DABoolean (this introduced Sol2.6/8/OSF differences, data/MC differences, as well as being wrong).
//

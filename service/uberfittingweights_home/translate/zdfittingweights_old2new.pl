...
open(LAYER, "version$layer_version.zdweightlayer");
open(DRIFT, "version$drift_version.zdweightdrift");
open(THETA, "version$theta_version.zdweighttheta");
...
open(DRIFT2, "> emulate_$layer_version-$drift_version-$theta_version\_$run_start-$run_stop.zdweight2layerdriftentang");

print DRIFT2 "$run_start $run_stop 0 0 0 0 0 0 DEFAULT\n";
print (DRIFT2 6 * $drift_nbins * 2 + 4, "\n");
...
open(THETA2, "> emulate_$layer_version-$drift_version-$theta_version\_$run_start-$run_stop.zdweight2layertheta");

print THETA2 "$run_start $run_stop 0 0 0 0 0 0 DEFAULT\n";
print (THETA2 6 * $theta_nbins + 2, "\n");

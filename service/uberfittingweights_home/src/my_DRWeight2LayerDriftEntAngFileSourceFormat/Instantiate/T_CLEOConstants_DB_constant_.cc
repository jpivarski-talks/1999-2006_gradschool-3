...
// Module:      T_CLEOConstants_DB_constant_
// 
...
// $Id: T_CLEOConstants_DB_constant_.cc,v 1.2 1999/05/08 21:42:49 cdj Exp $
//
// Revision history
//
// $Log: T_CLEOConstants_DB_constant_.cc,v $
...
INSTANTIATE_ONE( CLEOConstants< DB_constant_ > ) 

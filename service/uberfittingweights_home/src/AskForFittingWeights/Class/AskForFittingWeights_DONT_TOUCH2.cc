...
// Module:      AskForFittingWeights_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor AskForFittingWeights:
//              creates a new AskForFittingWeights instance each time 
...
makeProcessor( void )
{
   return new AskForFittingWeights;
}

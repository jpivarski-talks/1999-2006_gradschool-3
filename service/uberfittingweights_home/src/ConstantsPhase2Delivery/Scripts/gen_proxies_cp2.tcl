...
set skelFileName "CP2ProxyDeliverer_registerFactories.cc"
...
while { [ gets $skelFile line ] >= 0 } {
	...
	foreach constInfo $table {
	    ...
	    puts $outFile "     new DBCP2ProxyFactoryTemplate< DB$constName > );"
	}
    }
	...
	foreach constInfo $table {
	    ...
	    puts $outFile "template class DBCP2ProxyFactoryTemplate< DB$constName >;"
	    puts $outFile "template class DBCP2Proxy< DB$constName >;"
	}
    }

...
// $Id: DriftFunctionProxy.cc,v 1.16 2003/10/10 17:35:03 mccann Exp $
//
// Revision history
//
// $Log: DriftFunctionProxy.cc,v $
// Revision 1.16  2003/10/10 17:35:03  mccann
...
// 		     m_dataHolder.ThetaWeight()     );
	    extract( (iRecord.frame()).record(DrStream::kWeight2LayerDriftEntAng ),
		     m_dataHolder.LayerDriftEntAngWeight() );
	    extract( (iRecord.frame()).record(DrStream::kWeight2LayerTheta ),
		     m_dataHolder.LayerThetaWeight() );
	    extract( (iRecord.frame()).record(DrStream::kWeight2LayerPhi ),

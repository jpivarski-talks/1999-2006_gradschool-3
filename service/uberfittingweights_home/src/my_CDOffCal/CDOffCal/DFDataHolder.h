...
// $Id: DFDataHolder.h,v 1.5 2003/10/10 17:34:59 mccann Exp $
//
// Revision history
//
// $Log: DFDataHolder.h,v $
// Revision 1.5  2003/10/10 17:34:59  mccann
...
//       }
      FANonSeqConstants<DBDRWeight2LayerDriftEntAng>& LayerDriftEntAngWeight() {
	 return m_LayerDriftEntAngWeight;
      }
      FANonSeqConstants<DBDRWeight2LayerTheta>& LayerThetaWeight() {
	 return m_LayerThetaWeight;
      }
      FANonSeqConstants<DBDRWeight2LayerPhi>& LayerPhiWeight() {
...
// 	 return m_ThetaWeights;
//       }
//       FANonSeqConstants<DBDRWeight2LayerDriftEntAng> LayerDriftEntAngWeight() const {
// 	 return m_LayerDriftEntAngWeight;
//       }
//       FANonSeqConstants<DBDRWeight2LayerTheta> LayerThetaWeight() const {
// 	 return m_LayerThetaWeight;
//       }
//       FANonSeqConstants<DBDRWeight2LayerPhi> LayerPhiWeight() const {
// 	 return m_LayerPhiWeight;
//       }
// done
...
//       FAConstants< DBDRWeightTheta   > m_ThetaWeights;
      ...
      FANonSeqConstants<DBDRWeight2LayerDriftEntAng> m_LayerDriftEntAngWeight;
      FANonSeqConstants<DBDRWeight2LayerTheta> m_LayerThetaWeight;
      FANonSeqConstants<DBDRWeight2LayerPhi> m_LayerPhiWeight;

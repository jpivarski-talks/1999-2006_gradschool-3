...
// $Id: DriftFunction.h,v 1.40 2003/10/10 17:34:59 mccann Exp $
//
// Revision history
//
// $Log: DriftFunction.h,v $
// Revision 1.40  2003/10/10 17:34:59  mccann
...
public:
  ...
  virtual Resolution  resolution(int layer,Drift drift,float costheta,float phi,float sinalpha) const;

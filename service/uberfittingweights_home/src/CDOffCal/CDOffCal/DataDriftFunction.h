...
// $Id: DataDriftFunction.h,v 1.6 2003/10/03 12:54:30 dubrovin Exp $
//
// Revision history
//
// $Log: DataDriftFunction.h,v $
// Revision 1.6  2003/10/03 12:54:30  dubrovin
...
// New mapping scheme for drift dist vs time correction dased on data responce.

  static const float kCorr_TimeMaxA,
                     kCorr_EAngleMaxA;
  static const int   kCorr_FileSizeA;

  /* Map for data calibrated constants 
     kCorr_EAngleBinsA    # of 5o Entrange angle bins and extreme e-angles +-90o
     kCorr_DriftCorrBinsA # of >Time< Bins in >Drift< Correction (0-500ns)/20+1
  */

   enum ArrayLengthsA  
   { kCorr_EAngleBinsA   =37, 
     kAmbiguitiesA       = 2,
     kCorr_TimeBinsA     =26 };
...
private:
  ...
  float kCorr_EAngleBinSizeA,
        kCorr_TimeBinSizeA;  
  float corrDriftA[kCorr_EAngleBinsA][kAmbiguitiesA][kCorr_TimeBinsA] ;

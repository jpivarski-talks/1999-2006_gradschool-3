...
// $Id: ZDDriftFunctionProd.cc,v 1.1.1.1 2003/06/26 19:02:50 huanggs Exp $
//
// Revision history
//
// $Log: ZDDriftFunctionProd.cc,v $
...
static const char* const kFacilityString = "Processor.ZDDriftFunctionProd" ;

//---------------------------------------------------------------------------
// CONSTRUCTOR
//
ZDDriftFunctionProd::ZDDriftFunctionProd( void ) : 
     Producer("ZDDriftFunctionProd" ), 
     m_DriftFunctionType(
              "DriftFunctionType",
              this,
...
//			new ProxyFactoryFunction<ZDDriftFunctionProd,
//			                         DriftFunctionProxy>
//			( *this,
//			  &ZDDriftFunctionProd::makeDriftFunctionProxy ),
//			UsageTag() );
...
template class ProxyFactoryFunction<ZDDriftFunctionProd,ZDDriftFunctionProxy>;

//-------------------------------------------------------------------------------------------
//
// DESTRUCTOR
//
ZDDriftFunctionProd::~ZDDriftFunctionProd()
...
//
void
ZDDriftFunctionProd::terminate( void )
{

#if !defined(ZDDRIFTFUNCTION_HITQUALITY_H)
#define ZDDRIFTFUNCTION_HITQUALITY_H
// -*- C++ -*-
//
...
// $Id: ZDHitQuality.h,v 1.1.1.1 2003/06/26 19:02:49 huanggs Exp $
//
// Revision history
//
...
#endif /* ZDDRIFTFUNCTION_HITQUALITY_H */

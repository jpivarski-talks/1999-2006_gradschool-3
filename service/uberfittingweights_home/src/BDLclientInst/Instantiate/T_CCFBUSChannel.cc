...
// Module:      TCCFBUSChannel
// 
// Description: Instantiate templates needed to extract a DBCCFBUSChannel from
//              the Frame
//
// Implementation:

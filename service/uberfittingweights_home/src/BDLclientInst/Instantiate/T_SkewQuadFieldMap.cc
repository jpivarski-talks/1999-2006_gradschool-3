...
// Module:      TSkewQuadFieldMap
// 
// Description: Instantiate templates needed to extract a DBSkewQuadFieldMap from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSkewQuadFieldMap)
...
typedef DBSkewQuadFieldMap _vector_contents_;

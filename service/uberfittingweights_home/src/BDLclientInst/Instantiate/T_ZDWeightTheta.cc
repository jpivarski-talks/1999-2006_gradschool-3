...
// Module:      TZDWeightTheta
// 
// Description: Instantiate templates needed to extract a DBZDWeightTheta from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDWeightTheta)
...
typedef DBZDWeightTheta _vector_contents_;

...
// Module:      TDRadcsaturation
// 
// Description: Instantiate templates needed to extract a DBDRadcsaturation from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRadcsaturation)
...
typedef DBDRadcsaturation _vector_contents_;

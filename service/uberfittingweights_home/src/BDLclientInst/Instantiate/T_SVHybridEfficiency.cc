...
// Module:      TSVHybridEfficiency
// 
// Description: Instantiate templates needed to extract a DBSVHybridEfficiency from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVHybridEfficiency)
...
typedef DBSVHybridEfficiency _vector_contents_;

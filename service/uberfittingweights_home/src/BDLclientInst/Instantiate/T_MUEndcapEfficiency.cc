...
// Module:      TMUEndcapEfficiency
// 
// Description: Instantiate templates needed to extract a DBMUEndcapEfficiency from
//              the Frame
//
// Implementation:
...
#include "DBMUEndcapEfficiency.hh"
...
INSTANTIATE_CONSTANTS(DBMUEndcapEfficiency)
...
typedef DBMUEndcapEfficiency _vector_contents_;

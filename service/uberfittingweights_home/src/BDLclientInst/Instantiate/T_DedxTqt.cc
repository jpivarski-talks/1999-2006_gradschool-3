...
// Module:      TDedxTqt
// 
// Description: Instantiate templates needed to extract a DBDedxTqt from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxTqt)
...
typedef DBDedxTqt _vector_contents_;

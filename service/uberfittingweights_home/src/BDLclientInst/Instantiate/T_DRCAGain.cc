...
// Module:      TDRCAGain
// 
// Description: Instantiate templates needed to extract a DBDRCAGain from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRCAGain)
...
typedef DBDRCAGain _vector_contents_;

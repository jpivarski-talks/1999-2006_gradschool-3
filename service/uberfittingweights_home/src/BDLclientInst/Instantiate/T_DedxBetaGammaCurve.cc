...
// Module:      TDedxBetaGammaCurve
// 
// Description: Instantiate templates needed to extract a DBDedxBetaGammaCurve from
//              the Frame
//
// Implementation:
...
#include "DBDedxBetaGammaCurve.hh"
...
INSTANTIATE_CONSTANTS(DBDedxBetaGammaCurve)
...
typedef DBDedxBetaGammaCurve _vector_contents_;

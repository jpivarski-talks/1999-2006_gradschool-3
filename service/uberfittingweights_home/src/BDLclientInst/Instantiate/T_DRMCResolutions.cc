...
// Module:      TDRMCResolutions
// 
// Description: Instantiate templates needed to extract a DBDRMCResolutions from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRMCResolutions)
...
typedef DBDRMCResolutions _vector_contents_;

...
// Module:      TDedxCos
// 
// Description: Instantiate templates needed to extract a DBDedxCos from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxCos)
...
typedef DBDedxCos _vector_contents_;

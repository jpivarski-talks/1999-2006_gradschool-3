...
// Module:      TMUPoissonValues
// 
// Description: Instantiate templates needed to extract a DBMUPoissonValues from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBMUPoissonValues)
...
typedef DBMUPoissonValues _vector_contents_;

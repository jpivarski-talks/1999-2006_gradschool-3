...
// Module:      TMUEfficiency
// 
// Description: Instantiate templates needed to extract a DBMUEfficiency from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBMUEfficiency)
...
typedef DBMUEfficiency _vector_contents_;

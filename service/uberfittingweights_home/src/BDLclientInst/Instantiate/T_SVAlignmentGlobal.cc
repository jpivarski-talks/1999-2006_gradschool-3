...
// Module:      TSVAlignmentGlobal
// 
// Description: Instantiate templates needed to extract a DBSVAlignmentGlobal from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVAlignmentGlobal)
...
typedef DBSVAlignmentGlobal _vector_contents_;

...
// Module:      TDedxResolution
// 
// Description: Instantiate templates needed to extract a DBDedxResolution from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxResolution)
...
typedef DBDedxResolution _vector_contents_;

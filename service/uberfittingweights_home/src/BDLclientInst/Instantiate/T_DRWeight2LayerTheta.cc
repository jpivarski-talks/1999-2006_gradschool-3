...
// Module:      TDRWeight2LayerTheta
// 
// Description: Instantiate templates needed to extract a DBDRWeight2LayerTheta from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRWeight2LayerTheta)

#include "FrameAccess/instantiate_nonseqconstant.h"
#include "FrameAccess/instantiate_nonseqconstant.h"

//also need a vector of the constants
typedef DBDRWeight2LayerTheta _vector_contents_;

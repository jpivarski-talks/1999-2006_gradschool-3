...
// Module:      TZDWeight2LayerDriftEntAng
// 
// Description: Instantiate templates needed to extract a DBZDWeight2LayerDriftEntAng from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDWeight2LayerDriftEntAng)

#include "FrameAccess/instantiate_nonseqconstant.h"
#include "FrameAccess/instantiate_nonseqconstant.h"

//also need a vector of the constants
typedef DBZDWeight2LayerDriftEntAng _vector_contents_;

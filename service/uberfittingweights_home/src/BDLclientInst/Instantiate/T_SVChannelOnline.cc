...
// Module:      TSVChannelOnline
// 
// Description: Instantiate templates needed to extract a DBSVChannelOnline from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVChannelOnline)
...
typedef DBSVChannelOnline _vector_contents_;

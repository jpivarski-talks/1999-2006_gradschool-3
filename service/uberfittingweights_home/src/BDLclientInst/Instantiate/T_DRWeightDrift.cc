...
// Module:      TDRWeightDrift
// 
// Description: Instantiate templates needed to extract a DBDRWeightDrift from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRWeightDrift)
...
typedef DBDRWeightDrift _vector_contents_;

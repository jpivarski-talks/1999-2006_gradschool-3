...
// Module:      TDRMCCathname
// 
// Description: Instantiate templates needed to extract a DBDRMCCathname from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRMCCathname)
...
typedef DBDRMCCathname _vector_contents_;

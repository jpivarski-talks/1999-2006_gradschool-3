...
// Module:      TADRGeomCathodePanels
// 
// Description: Instantiate templates needed to extract a DBADRGeomCathodePanels from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBADRGeomCathodePanels)
...
typedef DBADRGeomCathodePanels _vector_contents_;

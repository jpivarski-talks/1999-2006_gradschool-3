...
// Module:      TDedxRun
// 
// Description: Instantiate templates needed to extract a DBDedxRun from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxRun)
...
typedef DBDedxRun _vector_contents_;

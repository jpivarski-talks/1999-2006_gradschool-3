...
// Module:      TSuperConductingQuadFieldMap
// 
// Description: Instantiate templates needed to extract a DBSuperConductingQuadFieldMap from
//              the Frame
//
// Implementation:
...
#include "DBSuperConductingQuadFieldMap.hh"
...
INSTANTIATE_CONSTANTS(DBSuperConductingQuadFieldMap)
...
typedef DBSuperConductingQuadFieldMap _vector_contents_;

...
// Module:      TSVAlignmentLadder
// 
// Description: Instantiate templates needed to extract a DBSVAlignmentLadder from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVAlignmentLadder)
...
typedef DBSVAlignmentLadder _vector_contents_;

...
// Module:      TDRWeightLayer
// 
// Description: Instantiate templates needed to extract a DBDRWeightLayer from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRWeightLayer)
...
typedef DBDRWeightLayer _vector_contents_;

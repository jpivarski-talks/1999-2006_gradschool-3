...
// Module:      TMUSaturation
// 
// Description: Instantiate templates needed to extract a DBMUSaturation from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBMUSaturation)
...
typedef DBMUSaturation _vector_contents_;

...
// Module:      TDedxTrkSat
// 
// Description: Instantiate templates needed to extract a DBDedxTrkSat from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxTrkSat)
...
typedef DBDedxTrkSat _vector_contents_;

...
// Module:      TMagFudge
// 
// Description: Instantiate templates needed to extract a DBMagFudge from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBMagFudge)
...
typedef DBMagFudge _vector_contents_;

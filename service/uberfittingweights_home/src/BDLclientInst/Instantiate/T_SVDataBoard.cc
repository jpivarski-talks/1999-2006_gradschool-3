...
// Module:      TSVDataBoard
// 
// Description: Instantiate templates needed to extract a DBSVDataBoard from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVDataBoard)
...
typedef DBSVDataBoard _vector_contents_;

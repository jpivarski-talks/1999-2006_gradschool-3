...
// Module:      TADRGeomLayersEnds
// 
// Description: Instantiate templates needed to extract a DBADRGeomLayersEnds from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBADRGeomLayersEnds)
...
typedef DBADRGeomLayersEnds _vector_contents_;

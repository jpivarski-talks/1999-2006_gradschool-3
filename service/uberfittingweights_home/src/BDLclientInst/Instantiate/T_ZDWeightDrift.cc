...
// Module:      TZDWeightDrift
// 
// Description: Instantiate templates needed to extract a DBZDWeightDrift from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDWeightDrift)
...
typedef DBZDWeightDrift _vector_contents_;

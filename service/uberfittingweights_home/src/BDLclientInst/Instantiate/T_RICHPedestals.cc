...
// Module:      TRICHPedestals
// 
// Description: Instantiate templates needed to extract a DBRICHPedestals from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBRICHPedestals)
...
typedef DBRICHPedestals _vector_contents_;

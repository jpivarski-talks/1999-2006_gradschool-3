...
// Module:      TCCBBCalOverallGain
// 
// Description: Instantiate templates needed to extract a DBCCBBCalOverallGain from
//              the Frame
//
// Implementation:
...
#include "DBCCBBCalOverallGain.hh"
...
INSTANTIATE_CONSTANTS(DBCCBBCalOverallGain)
...
typedef DBCCBBCalOverallGain _vector_contents_;

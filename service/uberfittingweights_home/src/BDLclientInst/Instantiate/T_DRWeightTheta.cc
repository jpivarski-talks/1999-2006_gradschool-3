...
// Module:      TDRWeightTheta
// 
// Description: Instantiate templates needed to extract a DBDRWeightTheta from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRWeightTheta)
...
typedef DBDRWeightTheta _vector_contents_;

...
// Module:      TMUChargeDivisionCounter
// 
// Description: Instantiate templates needed to extract a DBMUChargeDivisionCounter from
//              the Frame
//
// Implementation:
...
#include "DBMUChargeDivisionCounter.hh"
...
INSTANTIATE_CONSTANTS(DBMUChargeDivisionCounter)
...
typedef DBMUChargeDivisionCounter _vector_contents_;

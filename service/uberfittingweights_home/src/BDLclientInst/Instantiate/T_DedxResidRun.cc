...
// Module:      TDedxResidRun
// 
// Description: Instantiate templates needed to extract a DBDedxResidRun from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxResidRun)
...
typedef DBDedxResidRun _vector_contents_;

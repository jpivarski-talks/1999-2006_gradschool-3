...
// Module:      TDRFBUSChannel
// 
// Description: Instantiate templates needed to extract a DBDRFBUSChannel from
//              the Frame
//
// Implementation:

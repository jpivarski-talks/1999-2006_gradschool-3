...
// Module:      TCCDaqPeelMap
// 
// Description: Instantiate templates needed to extract a DBCCDaqPeelMap from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBCCDaqPeelMap)
...
typedef DBCCDaqPeelMap _vector_contents_;

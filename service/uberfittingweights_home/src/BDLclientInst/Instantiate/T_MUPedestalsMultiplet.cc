...
// Module:      TMUPedestalsMultiplet
// 
// Description: Instantiate templates needed to extract a DBMUPedestalsMultiplet from
//              the Frame
//
// Implementation:
...
#include "DBMUPedestalsMultiplet.hh"
...
INSTANTIATE_CONSTANTS(DBMUPedestalsMultiplet)
...
typedef DBMUPedestalsMultiplet _vector_contents_;

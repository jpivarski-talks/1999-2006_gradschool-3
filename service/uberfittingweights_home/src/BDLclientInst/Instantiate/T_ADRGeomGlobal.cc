...
// Module:      TADRGeomGlobal
// 
// Description: Instantiate templates needed to extract a DBADRGeomGlobal from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBADRGeomGlobal)
...
typedef DBADRGeomGlobal _vector_contents_;

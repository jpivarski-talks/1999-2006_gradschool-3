...
// Module:      TTrigMCCCATOC
// 
// Description: Instantiate templates needed to extract a DBTrigMCCCATOC from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBTrigMCCCATOC)
...
typedef DBTrigMCCCATOC _vector_contents_;

...
// Module:      TZDGeomAlignment
// 
// Description: Instantiate templates needed to extract a DBZDGeomAlignment from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDGeomAlignment)
...
typedef DBZDGeomAlignment _vector_contents_;

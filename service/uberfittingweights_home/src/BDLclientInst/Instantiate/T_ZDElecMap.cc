...
// Module:      TZDElecMap
// 
// Description: Instantiate templates needed to extract a DBZDElecMap from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDElecMap)
...
typedef DBZDElecMap _vector_contents_;

...
// Module:      TMUPulseHeight
// 
// Description: Instantiate templates needed to extract a DBMUPulseHeight from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBMUPulseHeight)
...
typedef DBMUPulseHeight _vector_contents_;

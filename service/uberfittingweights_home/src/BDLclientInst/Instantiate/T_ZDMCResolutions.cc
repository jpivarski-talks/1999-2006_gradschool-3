...
// Module:      TZDMCResolutions
// 
// Description: Instantiate templates needed to extract a DBZDMCResolutions from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDMCResolutions)
...
typedef DBZDMCResolutions _vector_contents_;

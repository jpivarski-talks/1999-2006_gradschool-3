...
// Module:      TSVAlignmentLayer
// 
// Description: Instantiate templates needed to extract a DBSVAlignmentLayer from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVAlignmentLayer)
...
typedef DBSVAlignmentLayer _vector_contents_;

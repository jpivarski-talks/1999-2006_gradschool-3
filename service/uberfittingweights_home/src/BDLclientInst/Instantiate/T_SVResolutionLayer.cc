...
// Module:      TSVResolutionLayer
// 
// Description: Instantiate templates needed to extract a DBSVResolutionLayer from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVResolutionLayer)
...
typedef DBSVResolutionLayer _vector_contents_;

...
// Module:      TSVHybrid
// 
// Description: Instantiate templates needed to extract a DBSVHybrid from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVHybrid)
...
typedef DBSVHybrid _vector_contents_;

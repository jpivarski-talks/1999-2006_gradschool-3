...
// Module:      TRICHMargins
// 
// Description: Instantiate templates needed to extract a DBRICHMargins from
//              the Frame
//
// Implementation:

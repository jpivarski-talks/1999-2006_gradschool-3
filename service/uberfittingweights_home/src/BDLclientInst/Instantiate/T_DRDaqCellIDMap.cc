...
// Module:      TDRDaqCellIDMap
// 
// Description: Instantiate templates needed to extract a DBDRDaqCellIDMap from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRDaqCellIDMap)
...
typedef DBDRDaqCellIDMap _vector_contents_;

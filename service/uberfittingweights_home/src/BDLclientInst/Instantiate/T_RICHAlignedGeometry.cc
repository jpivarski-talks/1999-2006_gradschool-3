...
// Module:      TRICHAlignedGeometry
// 
// Description: Instantiate templates needed to extract a DBRICHAlignedGeometry from
//              the Frame
//
// Implementation:
...
#include "DBRICHAlignedGeometry.hh"
...
INSTANTIATE_CONSTANTS(DBRICHAlignedGeometry)
...
typedef DBRICHAlignedGeometry _vector_contents_;

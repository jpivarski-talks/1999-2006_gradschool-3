...
// Module:      TTRIGCesrOffset
// 
// Description: Instantiate templates needed to extract a DBTRIGCesrOffset from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBTRIGCesrOffset)
...
typedef DBTRIGCesrOffset _vector_contents_;

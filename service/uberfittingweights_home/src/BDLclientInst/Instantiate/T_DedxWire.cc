...
// Module:      TDedxWire
// 
// Description: Instantiate templates needed to extract a DBDedxWire from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxWire)
...
typedef DBDedxWire _vector_contents_;

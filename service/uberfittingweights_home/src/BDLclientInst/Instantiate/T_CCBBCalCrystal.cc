...
// Module:      TCCBBCalCrystal
// 
// Description: Instantiate templates needed to extract a DBCCBBCalCrystal from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBCCBBCalCrystal)
...
typedef DBCCBBCalCrystal _vector_contents_;

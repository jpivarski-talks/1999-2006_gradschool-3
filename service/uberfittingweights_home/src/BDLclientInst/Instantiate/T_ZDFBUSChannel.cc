...
// Module:      TZDFBUSChannel
// 
// Description: Instantiate templates needed to extract a DBZDFBUSChannel from
//              the Frame
//
// Implementation:

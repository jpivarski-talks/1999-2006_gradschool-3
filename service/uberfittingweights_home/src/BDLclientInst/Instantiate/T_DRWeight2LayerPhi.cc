...
// Module:      TDRWeight2LayerPhi
// 
// Description: Instantiate templates needed to extract a DBDRWeight2LayerPhi from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRWeight2LayerPhi)

#include "FrameAccess/instantiate_nonseqconstant.h"
#include "FrameAccess/instantiate_nonseqconstant.h"

//also need a vector of the constants
typedef DBDRWeight2LayerPhi _vector_contents_;

...
// Module:      TDRadc2charge
// 
// Description: Instantiate templates needed to extract a DBDRadc2charge from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRadc2charge)
...
typedef DBDRadc2charge _vector_contents_;

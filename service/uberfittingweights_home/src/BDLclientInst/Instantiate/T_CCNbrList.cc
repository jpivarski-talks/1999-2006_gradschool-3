...
// Module:      TCCNbrList
// 
// Description: Instantiate templates needed to extract a DBCCNbrList from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBCCNbrList)
...
typedef DBCCNbrList _vector_contents_;

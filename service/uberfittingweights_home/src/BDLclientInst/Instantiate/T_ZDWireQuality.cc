...
// Module:      TZDWireQuality
// 
// Description: Instantiate templates needed to extract a DBZDWireQuality from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDWireQuality)
...
typedef DBZDWireQuality _vector_contents_;

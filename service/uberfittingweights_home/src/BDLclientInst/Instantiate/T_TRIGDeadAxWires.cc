...
// Module:      TTRIGDeadAxWires
// 
// Description: Instantiate templates needed to extract a DBTRIGDeadAxWires from
//              the Frame
//
// Implementation:

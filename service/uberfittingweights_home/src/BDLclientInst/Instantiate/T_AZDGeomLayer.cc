...
// Module:      TAZDGeomLayer
// 
// Description: Instantiate templates needed to extract a DBAZDGeomLayer from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBAZDGeomLayer)
...
typedef DBAZDGeomLayer _vector_contents_;

...
// Module:      TDRCAPedestal
// 
// Description: Instantiate templates needed to extract a DBDRCAPedestal from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRCAPedestal)
...
typedef DBDRCAPedestal _vector_contents_;

...
// Module:      TDRElecMap
// 
// Description: Instantiate templates needed to extract a DBDRElecMap from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRElecMap)
...
typedef DBDRElecMap _vector_contents_;

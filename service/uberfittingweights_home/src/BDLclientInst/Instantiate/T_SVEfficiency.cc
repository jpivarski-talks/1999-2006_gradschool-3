...
// Module:      TSVEfficiency
// 
// Description: Instantiate templates needed to extract a DBSVEfficiency from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVEfficiency)
...
typedef DBSVEfficiency _vector_contents_;

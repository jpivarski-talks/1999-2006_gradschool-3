...
// Module:      TDRGarfield_DistanceCorrection
// 
// Description: Instantiate templates needed to extract a DBDRGarfield_DistanceCorrection from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRGarfield_DistanceCorrection)
...
typedef DBDRGarfield_DistanceCorrection _vector_contents_;

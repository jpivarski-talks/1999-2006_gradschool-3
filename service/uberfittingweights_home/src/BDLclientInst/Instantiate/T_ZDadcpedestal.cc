...
// Module:      TZDadcpedestal
// 
// Description: Instantiate templates needed to extract a DBZDadcpedestal from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDadcpedestal)
...
typedef DBZDadcpedestal _vector_contents_;

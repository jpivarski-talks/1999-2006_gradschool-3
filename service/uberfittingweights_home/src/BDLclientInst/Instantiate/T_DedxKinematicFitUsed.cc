...
// Module:      TDedxKinematicFitUsed
// 
// Description: Instantiate templates needed to extract a DBDedxKinematicFitUsed from
//              the Frame
//
// Implementation:
...
#include "DBDedxKinematicFitUsed.hh"
...
INSTANTIATE_CONSTANTS(DBDedxKinematicFitUsed)
...
typedef DBDedxKinematicFitUsed _vector_contents_;

...
// Module:      TMUECalChannel
// 
// Description: Instantiate templates needed to extract a DBMUECalChannel from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBMUECalChannel)
...
typedef DBMUECalChannel _vector_contents_;

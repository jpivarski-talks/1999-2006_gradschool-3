...
// Module:      TRICHChannel
// 
// Description: Instantiate templates needed to extract a DBRICHChannel from
//              the Frame
//
// Implementation:

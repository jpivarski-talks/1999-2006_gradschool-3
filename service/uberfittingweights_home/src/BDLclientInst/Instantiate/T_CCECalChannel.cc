...
// Module:      TCCECalChannel
// 
// Description: Instantiate templates needed to extract a DBCCECalChannel from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBCCECalChannel)
...
typedef DBCCECalChannel _vector_contents_;

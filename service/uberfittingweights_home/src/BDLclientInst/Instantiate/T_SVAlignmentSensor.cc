...
// Module:      TSVAlignmentSensor
// 
// Description: Instantiate templates needed to extract a DBSVAlignmentSensor from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVAlignmentSensor)
...
typedef DBSVAlignmentSensor _vector_contents_;

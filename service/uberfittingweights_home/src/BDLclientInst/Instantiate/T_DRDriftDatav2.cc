...
// Module:      TDRDriftDatav2
// 
// Description: Instantiate templates needed to extract a DBDRDriftDatav2 from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRDriftDatav2)
...
typedef DBDRDriftDatav2 _vector_contents_;

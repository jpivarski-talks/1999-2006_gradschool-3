...
// Module:      TDedxSaturation
// 
// Description: Instantiate templates needed to extract a DBDedxSaturation from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxSaturation)
...
typedef DBDedxSaturation _vector_contents_;

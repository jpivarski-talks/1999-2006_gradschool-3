...
// Module:      TDRadcpedestal
// 
// Description: Instantiate templates needed to extract a DBDRadcpedestal from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRadcpedestal)
...
typedef DBDRadcpedestal _vector_contents_;

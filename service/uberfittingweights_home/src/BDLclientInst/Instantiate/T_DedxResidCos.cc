...
// Module:      TDedxResidCos
// 
// Description: Instantiate templates needed to extract a DBDedxResidCos from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxResidCos)
...
typedef DBDedxResidCos _vector_contents_;

...
// Module:      TRICHTag
// 
// Description: Instantiate templates needed to extract a DBRICHTag from
//              the Frame
//
// Implementation:

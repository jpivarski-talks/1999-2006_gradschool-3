...
// Module:      TMUHomogenousValues
// 
// Description: Instantiate templates needed to extract a DBMUHomogenousValues from
//              the Frame
//
// Implementation:
...
#include "DBMUHomogenousValues.hh"
...
INSTANTIATE_CONSTANTS(DBMUHomogenousValues)
...
typedef DBMUHomogenousValues _vector_contents_;

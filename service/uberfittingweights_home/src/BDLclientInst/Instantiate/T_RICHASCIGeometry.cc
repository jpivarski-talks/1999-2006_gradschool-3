...
// Module:      TRICHASCIGeometry
// 
// Description: Instantiate templates needed to extract a DBRICHASCIGeometry from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBRICHASCIGeometry)
...
typedef DBRICHASCIGeometry _vector_contents_;

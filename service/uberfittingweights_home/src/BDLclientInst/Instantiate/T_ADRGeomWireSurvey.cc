...
// Module:      TADRGeomWireSurvey
// 
// Description: Instantiate templates needed to extract a DBADRGeomWireSurvey from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBADRGeomWireSurvey)
...
typedef DBADRGeomWireSurvey _vector_contents_;

...
// Module:      TDRGeomAlignment
// 
// Description: Instantiate templates needed to extract a DBDRGeomAlignment from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRGeomAlignment)
...
typedef DBDRGeomAlignment _vector_contents_;

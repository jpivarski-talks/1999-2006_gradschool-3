...
// Module:      TMUDeadCounterFlag
// 
// Description: Instantiate templates needed to extract a DBMUDeadCounterFlag from
//              the Frame
//
// Implementation:
...
#include "DBMUDeadCounterFlag.hh"
...
INSTANTIATE_CONSTANTS(DBMUDeadCounterFlag)
...
typedef DBMUDeadCounterFlag _vector_contents_;

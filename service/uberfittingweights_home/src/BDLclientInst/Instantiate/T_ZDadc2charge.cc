...
// Module:      TZDadc2charge
// 
// Description: Instantiate templates needed to extract a DBZDadc2charge from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDadc2charge)
...
typedef DBZDadc2charge _vector_contents_;

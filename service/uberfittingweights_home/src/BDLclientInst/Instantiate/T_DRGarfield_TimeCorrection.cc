...
// Module:      TDRGarfield_TimeCorrection
// 
// Description: Instantiate templates needed to extract a DBDRGarfield_TimeCorrection from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRGarfield_TimeCorrection)
...
typedef DBDRGarfield_TimeCorrection _vector_contents_;

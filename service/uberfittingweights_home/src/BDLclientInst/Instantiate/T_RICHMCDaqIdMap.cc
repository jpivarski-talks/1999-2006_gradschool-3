...
// Module:      TRICHMCDaqIdMap
// 
// Description: Instantiate templates needed to extract a DBRICHMCDaqIdMap from
//              the Frame
//
// Implementation:

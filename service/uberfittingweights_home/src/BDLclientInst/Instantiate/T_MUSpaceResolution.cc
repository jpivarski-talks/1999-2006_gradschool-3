...
// Module:      TMUSpaceResolution
// 
// Description: Instantiate templates needed to extract a DBMUSpaceResolution from
//              the Frame
//
// Implementation:
...
#include "DBMUSpaceResolution.hh"
...
INSTANTIATE_CONSTANTS(DBMUSpaceResolution)
...
typedef DBMUSpaceResolution _vector_contents_;

...
// Module:      TSVRPhiHitRadialCorrections
// 
// Description: Instantiate templates needed to extract a DBSVRPhiHitRadialCorrections from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVRPhiHitRadialCorrections)
...
typedef DBSVRPhiHitRadialCorrections _vector_contents_;

...
// Module:      TSVResolutionGlobal
// 
// Description: Instantiate templates needed to extract a DBSVResolutionGlobal from
//              the Frame
//
// Implementation:
...
#include "DBSVResolutionGlobal.hh"
...
INSTANTIATE_CONSTANTS(DBSVResolutionGlobal)
...
typedef DBSVResolutionGlobal _vector_contents_;

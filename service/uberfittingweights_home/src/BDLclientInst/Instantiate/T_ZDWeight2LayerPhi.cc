...
// Module:      TZDWeight2LayerPhi
// 
// Description: Instantiate templates needed to extract a DBZDWeight2LayerPhi from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDWeight2LayerPhi)

#include "FrameAccess/instantiate_nonseqconstant.h"
#include "FrameAccess/instantiate_nonseqconstant.h"

//also need a vector of the constants
typedef DBZDWeight2LayerPhi _vector_contents_;

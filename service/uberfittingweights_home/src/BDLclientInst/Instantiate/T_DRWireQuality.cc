...
// Module:      TDRWireQuality
// 
// Description: Instantiate templates needed to extract a DBDRWireQuality from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRWireQuality)
...
typedef DBDRWireQuality _vector_contents_;

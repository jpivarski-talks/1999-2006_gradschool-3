...
// Module:      TMUDeadMultipletFlag
// 
// Description: Instantiate templates needed to extract a DBMUDeadMultipletFlag from
//              the Frame
//
// Implementation:
...
#include "DBMUDeadMultipletFlag.hh"
...
INSTANTIATE_CONSTANTS(DBMUDeadMultipletFlag)
...
typedef DBMUDeadMultipletFlag _vector_contents_;

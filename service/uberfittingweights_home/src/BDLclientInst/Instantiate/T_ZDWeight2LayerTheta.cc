...
// Module:      TZDWeight2LayerTheta
// 
// Description: Instantiate templates needed to extract a DBZDWeight2LayerTheta from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDWeight2LayerTheta)

#include "FrameAccess/instantiate_nonseqconstant.h"
#include "FrameAccess/instantiate_nonseqconstant.h"

//also need a vector of the constants
typedef DBZDWeight2LayerTheta _vector_contents_;

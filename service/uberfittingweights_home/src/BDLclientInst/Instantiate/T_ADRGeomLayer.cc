...
// Module:      TADRGeomLayer
// 
// Description: Instantiate templates needed to extract a DBADRGeomLayer from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBADRGeomLayer)
...
typedef DBADRGeomLayer _vector_contents_;

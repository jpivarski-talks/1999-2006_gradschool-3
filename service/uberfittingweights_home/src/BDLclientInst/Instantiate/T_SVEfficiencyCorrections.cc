...
// Module:      TSVEfficiencyCorrections
// 
// Description: Instantiate templates needed to extract a DBSVEfficiencyCorrections from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVEfficiencyCorrections)
...
typedef DBSVEfficiencyCorrections _vector_contents_;

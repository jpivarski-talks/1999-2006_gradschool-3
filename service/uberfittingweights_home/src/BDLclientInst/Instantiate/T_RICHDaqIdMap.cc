...
// Module:      TRICHDaqIdMap
// 
// Description: Instantiate templates needed to extract a DBRICHDaqIdMap from
//              the Frame
//
// Implementation:

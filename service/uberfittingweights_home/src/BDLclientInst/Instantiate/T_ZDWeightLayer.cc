...
// Module:      TZDWeightLayer
// 
// Description: Instantiate templates needed to extract a DBZDWeightLayer from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDWeightLayer)
...
typedef DBZDWeightLayer _vector_contents_;

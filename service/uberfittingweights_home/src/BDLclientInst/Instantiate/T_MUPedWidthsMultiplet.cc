...
// Module:      TMUPedWidthsMultiplet
// 
// Description: Instantiate templates needed to extract a DBMUPedWidthsMultiplet from
//              the Frame
//
// Implementation:
...
#include "DBMUPedWidthsMultiplet.hh"
...
INSTANTIATE_CONSTANTS(DBMUPedWidthsMultiplet)
...
typedef DBMUPedWidthsMultiplet _vector_contents_;

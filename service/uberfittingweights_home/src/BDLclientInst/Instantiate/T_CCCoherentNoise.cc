...
// Module:      TCCCoherentNoise
// 
// Description: Instantiate templates needed to extract a DBCCCoherentNoise from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBCCCoherentNoise)
...
typedef DBCCCoherentNoise _vector_contents_;

...
// Module:      TSVL3Channel
// 
// Description: Instantiate templates needed to extract a DBSVL3Channel from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBSVL3Channel)
...
typedef DBSVL3Channel _vector_contents_;

...
// Module:      TDRWeight2LayerDriftEntAng
// 
// Description: Instantiate templates needed to extract a DBDRWeight2LayerDriftEntAng from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRWeight2LayerDriftEntAng)

#include "FrameAccess/instantiate_nonseqconstant.h"
#include "FrameAccess/instantiate_nonseqconstant.h"

//also need a vector of the constants
typedef DBDRWeight2LayerDriftEntAng _vector_contents_;

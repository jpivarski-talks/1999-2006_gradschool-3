...
// Module:      TDedxDcaSin
// 
// Description: Instantiate templates needed to extract a DBDedxDcaSin from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxDcaSin)
...
typedef DBDedxDcaSin _vector_contents_;

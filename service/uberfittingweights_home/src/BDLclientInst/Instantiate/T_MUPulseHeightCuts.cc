...
// Module:      TMUPulseHeightCuts
// 
// Description: Instantiate templates needed to extract a DBMUPulseHeightCuts from
//              the Frame
//
// Implementation:
...
#include "DBMUPulseHeightCuts.hh"
...
INSTANTIATE_CONSTANTS(DBMUPulseHeightCuts)
...
typedef DBMUPulseHeightCuts _vector_contents_;

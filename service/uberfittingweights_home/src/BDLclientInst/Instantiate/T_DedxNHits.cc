...
// Module:      TDedxNHits
// 
// Description: Instantiate templates needed to extract a DBDedxNHits from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxNHits)
...
typedef DBDedxNHits _vector_contents_;

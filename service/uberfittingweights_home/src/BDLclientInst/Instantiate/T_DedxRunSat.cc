...
// Module:      TDedxRunSat
// 
// Description: Instantiate templates needed to extract a DBDedxRunSat from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDedxRunSat)
...
typedef DBDedxRunSat _vector_contents_;

...
// Module:      TMUPickup
// 
// Description: Instantiate templates needed to extract a DBMUPickup from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBMUPickup)
...
typedef DBMUPickup _vector_contents_;

...
// Module:      TZDDaqCellIDMap
// 
// Description: Instantiate templates needed to extract a DBZDDaqCellIDMap from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBZDDaqCellIDMap)
...
typedef DBZDDaqCellIDMap _vector_contents_;

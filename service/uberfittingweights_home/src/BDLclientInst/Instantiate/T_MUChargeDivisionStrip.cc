...
// Module:      TMUChargeDivisionStrip
// 
// Description: Instantiate templates needed to extract a DBMUChargeDivisionStrip from
//              the Frame
//
// Implementation:
...
#include "DBMUChargeDivisionStrip.hh"
...
INSTANTIATE_CONSTANTS(DBMUChargeDivisionStrip)
...
typedef DBMUChargeDivisionStrip _vector_contents_;

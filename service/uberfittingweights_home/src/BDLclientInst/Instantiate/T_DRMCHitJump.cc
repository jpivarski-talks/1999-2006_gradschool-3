...
// Module:      TDRMCHitJump
// 
// Description: Instantiate templates needed to extract a DBDRMCHitJump from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRMCHitJump)
...
typedef DBDRMCHitJump _vector_contents_;

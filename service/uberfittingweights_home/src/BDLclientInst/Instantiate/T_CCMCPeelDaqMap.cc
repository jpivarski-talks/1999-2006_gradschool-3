...
// Module:      TCCMCPeelDaqMap
// 
// Description: Instantiate templates needed to extract a DBCCMCPeelDaqMap from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBCCMCPeelDaqMap)
...
typedef DBCCMCPeelDaqMap _vector_contents_;

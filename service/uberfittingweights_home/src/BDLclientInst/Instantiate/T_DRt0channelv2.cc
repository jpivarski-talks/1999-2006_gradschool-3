...
// Module:      TDRt0channelv2
// 
// Description: Instantiate templates needed to extract a DBDRt0channelv2 from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBDRt0channelv2)
...
typedef DBDRt0channelv2 _vector_contents_;

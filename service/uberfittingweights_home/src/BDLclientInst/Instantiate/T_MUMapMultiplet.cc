...
// Module:      TMUMapMultiplet
// 
// Description: Instantiate templates needed to extract a DBMUMapMultiplet from
//              the Frame
//
// Implementation:
...
INSTANTIATE_CONSTANTS(DBMUMapMultiplet)
...
typedef DBMUMapMultiplet _vector_contents_;

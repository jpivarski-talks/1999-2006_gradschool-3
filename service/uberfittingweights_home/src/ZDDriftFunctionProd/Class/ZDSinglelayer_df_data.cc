...
// $Id: ZDSinglelayer_df_data.cc,v 1.1.1.1 2003/06/26 19:02:50 huanggs Exp $
//
// Revision history
//
...
static const char* const kFacilityString   = "ZDDriftFunctionProd.ZDSinglelayer_df_data" ;

...
// $Id: ZDDriftFunction.cc,v 1.5 2003/10/16 13:56:46 mccann Exp $
//
// Revision history
//
...
// Revision 1.5  2003/10/16 13:56:46  mccann
// kFavoriteNumber must be the same type as m_Layer...Weight elements for comparison to be exact
//

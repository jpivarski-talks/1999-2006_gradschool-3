...
// $Id: ZDDriftFunctionProxy.cc,v 1.2 2003/10/10 17:36:40 mccann Exp $
//
// Revision history
//
...
// Revision 1.2  2003/10/10 17:36:40  mccann
...
#include "ZDDriftFunctionProd/ZDDataDriftFunction.h" 
...
//-----------------------------------------------------------------------------
//
static const char* const kFacilityString = "ZDDriftFunctionProd.ZDDriftFunctionProxy" ;
//
//-----------------------------------------------------------------------------
//
ZDDriftFunctionProxy::ZDDriftFunctionProxy(ZDDriftFunctionProd *ZDDriftFunctionProd): 
   m_DriftFunction(0),
   m_Producer(ZDDriftFunctionProd)
{
...
// 		     m_dataHolder.ThetaWeight()     );
	    extract( (iRecord.frame()).record(ZdStream::kWeight2LayerDriftEntAng ),
		     m_dataHolder.LayerDriftEntAngWeight() );
	    extract( (iRecord.frame()).record(ZdStream::kWeight2LayerTheta ),
		     m_dataHolder.LayerThetaWeight() );
	    extract( (iRecord.frame()).record(ZdStream::kWeight2LayerPhi ),
		     m_dataHolder.LayerPhiWeight() );

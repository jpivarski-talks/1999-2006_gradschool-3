...
// Module:      TwoTracksOnly_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TwoTracksOnly:
//              creates a new TwoTracksOnly instance each time 

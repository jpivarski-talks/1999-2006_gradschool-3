...
// Module:      MyOverlapHits_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor MyOverlapHits:
//              creates a new MyOverlapHits instance each time 

...
{
   static int taga;
   report( SYSTEM, kFacilityString ) << "TAGA " << taga << endl;
   taga++;
   ...
   {
      static int tagb;
      report( SYSTEM, kFacilityString ) << "TAGB " << tagb << endl;
      tagb++;
   ...
   {
      static int tagc;
      report( SYSTEM, kFacilityString ) << "TAGC " << tagc << endl;
      tagc++;
   ...
   {
      static int tagd;
      report( SYSTEM, kFacilityString ) << "TAGD " << tagd << endl;
      tagd++;
   ...
   { 
      static int tage;
      report( SYSTEM, kFacilityString ) << "TAGE " << tage << endl;
      tage++;

...
// $Id: STL_vectorOfMatchedSVHits.cc,v 1.1 1999/04/27 22:10:59 wsun Exp $
//
// Revision history
//
// $Log: STL_vectorOfMatchedSVHits.cc,v $
// Revision 1.1  1999/04/27 22:10:59  wsun
...
template class pair< const CalibratedSVRphiHit*, const CalibratedSVZHit* > ;

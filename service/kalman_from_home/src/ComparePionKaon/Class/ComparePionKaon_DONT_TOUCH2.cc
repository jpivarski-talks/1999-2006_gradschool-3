...
// Module:      ComparePionKaon_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor ComparePionKaon:
//              creates a new ComparePionKaon instance each time 

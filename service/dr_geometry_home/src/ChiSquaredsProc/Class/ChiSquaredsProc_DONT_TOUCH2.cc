...
// Module:      ChiSquaredsProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor ChiSquaredsProc:
//              creates a new ChiSquaredsProc instance each time 

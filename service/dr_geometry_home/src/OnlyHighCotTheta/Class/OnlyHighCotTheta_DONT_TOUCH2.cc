...
// Module:      OnlyHighCotTheta_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor OnlyHighCotTheta:
//              creates a new OnlyHighCotTheta instance each time 

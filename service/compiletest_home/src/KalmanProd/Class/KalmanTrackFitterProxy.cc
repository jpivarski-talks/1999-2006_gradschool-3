...
// $Id: KalmanTrackFitterProxy.cc,v 1.19 2003/09/10 20:59:46 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanTrackFitterProxy.cc,v 1.19 2003/09/10 20:59:46 wsun Exp $";
...
//    bind( &KalmanTrackFitterProxy::updateZDGeom,   Stream::kZDAlignment ) ;
}
...
// void
// KalmanTrackFitterProxy::updateZDGeom( const Record& iRecord )
// {
//    if( m_kalmanTrackFitter != 0 )
//    {
//       m_kalmanTrackFitter->updateZDSurfaceCache() ;

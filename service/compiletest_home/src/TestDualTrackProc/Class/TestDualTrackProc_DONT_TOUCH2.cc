...
// Module:      TestDualTrackProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TestDualTrackProc:
//              creates a new TestDualTrackProc instance each time 

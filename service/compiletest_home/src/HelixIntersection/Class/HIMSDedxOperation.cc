...
// $Id: HIMSDedxOperation.cc,v 1.9 2003/10/14 19:10:16 wsun Exp $
//
// Revision history
//
// $Log: HIMSDedxOperation.cc,v $
// Revision 1.9  2003/10/14 19:10:16  wsun
// Converted floats to doubles for improved platform independence.
//
...
static const char* const kIdString  = "$Id: HIMSDedxOperation.cc,v 1.9 2003/10/14 19:10:16 wsun Exp $";

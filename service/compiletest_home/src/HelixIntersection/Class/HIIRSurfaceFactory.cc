...
// $Id: HIIRSurfaceFactory.cc,v 1.4 2003/10/10 23:14:42 cdj Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: HIIRSurfaceFactory.cc,v 1.4 2003/10/10 23:14:42 cdj Exp $";

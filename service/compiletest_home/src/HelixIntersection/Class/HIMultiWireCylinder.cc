...
// $Id: HIMultiWireCylinder.cc,v 1.14 2003/09/01 19:50:16 wsun Exp $
//
// Revision history
//
// $Log: HIMultiWireCylinder.cc,v $
// Revision 1.14  2003/09/01 19:50:16  wsun
...
static const char* const kIdString  = "$Id: HIMultiWireCylinder.cc,v 1.14 2003/09/01 19:50:16 wsun Exp $";
...
HIMultiWireCylinder::setSingleHitAndDist( HitAndUsed* aHit )
{
   if( aHit != 0 )
   {
      setHICalibratedWireHit( &( aHit->first ) ) ;
   }
   else
   {
      setHICalibratedWireHit( 0 ) ;
   }
}

...
// $Id: HIDRSurfaceFactory.cc,v 1.32 2003/10/10 23:14:41 cdj Exp $
//
// Revision history
//
// $Log: HIDRSurfaceFactory.cc,v $
// Revision 1.32  2003/10/10 23:14:41  cdj
// now get DGMaterialStore from material stream
//
// Revision 1.31  2003/09/01 19:50:16  wsun
// * HIDRLayerCylinder --> HIWireLayerCylinder
// * HICalibratedDRHit --> HICalibratedWireHit
//
// Revision 1.30  2003/07/25 23:21:22  mccann
...
static const char* const kIdString  = "$Id: HIDRSurfaceFactory.cc,v 1.32 2003/10/10 23:14:41 cdj Exp $";
   ...
   double aFittingWeight ) const
{
   ...
   report(DEBUG, kFacilityString)
      ...
      << " > " << aHitInfo.calibratedDRHit() << " < " << aHitInfo.driftDistance()

...
// $Id: HIZDSurfaceFactory.h,v 1.3 2003/09/01 19:46:16 wsun Exp $
//
// Revision history
//
// $Log: HIZDSurfaceFactory.h,v $
// Revision 1.3  2003/09/01 19:46:16  wsun
// Replaced HIZDLayerCylinder with HIWireLayerCylinder.
//
// Revision 1.2  2003/08/30 00:24:46  wsun
...
class HIZDSurfaceFactory
{
   ...
   public:
	 ...
	 double aFittingWeight = 0. ) ;
      ...
      // Generate HIWireLayerCylinder surfaces for all ZD layers by default.
   ...
   private:
	 ...
	 double aFittingWeight = 0. ) const ;
      ...
      const ZDHitCorrector* m_hitCorrector ;

...
// $Id: HIFitHelix.h,v 1.16 2002/04/27 17:02:03 cleo3 Exp $
//
// Revision history
//
// $Log: HIFitHelix.h,v $
// Revision 1.16  2002/04/27 17:02:03  cleo3
...
class HIFitHelix : public HIHelix
{
   ...
   public:
	 ...
	 private:
      ...
      STL_VECTOR( HitAndLinkData )& hitsOnTrack()
      { return m_hitsOnTrack ; }

      const STL_VECTOR( HitAndLinkData )& hitsOnTrack() const
      { return m_hitsOnTrack ; }

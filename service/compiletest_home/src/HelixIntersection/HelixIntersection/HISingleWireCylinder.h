...
// $Id: HISingleWireCylinder.h,v 1.14 2003/09/01 19:52:37 wsun Exp $
//
// Revision history
//
// $Log: HISingleWireCylinder.h,v $
// Revision 1.14  2003/09/01 19:52:37  wsun
// * HIDRLayerCylinder --> HIWireLayerCylinder
// * HICalibratedDRHit --> HICalibratedWireHit
//
// Revision 1.13  2003/08/30 00:24:46  wsun
...
class HISingleWireCylinder : public HIWireLayerCylinder
{
   ...
   public:
	 ...
	 double                         aAverageChargeOnTrack = 0. ) ;
      ...
      // ---------- member functions ---------------------------
      void setHICalibratedWireHit( HICalibratedWireHit* aHit ) ;
   ...
   private:
      ...
      // instead of m_drHit, thus avoiding calling HICalibratedWireHit's
      // assignment operator repeatedly.
      HICalibratedWireHit* m_pDRHit ;
      HICalibratedWireHit  m_drHit ;

...
// $Id: HIDRSurfaceFactory.h,v 1.18 2003/09/01 19:52:37 wsun Exp $
//
// Revision history
//
// $Log: HIDRSurfaceFactory.h,v $
// Revision 1.18  2003/09/01 19:52:37  wsun
// * HIDRLayerCylinder --> HIWireLayerCylinder
// * HICalibratedDRHit --> HICalibratedWireHit
//
// Revision 1.17  2003/08/30 00:24:45  wsun
...
class HIDRSurfaceFactory
{
   ...
   public:
	 ...
	 double aFittingWeight = 0. ) ;
      ...
      // for layers with hits and HIWireLayerCylinders for layers without hits.
	 ...
	 double aFittingWeight = 0. ) ;
      ...
      // Generate HIWireLayerCylinder surfaces for all DR layers by default.

...
// $Id: T_FAItem_CathodeClusterHitLattice.cc,v 1.1 2000/03/03 15:15:33 lyon Exp $
//
// Revision history
// 
// $Log: T_FAItem_CathodeClusterHitLattice.cc,v $
// Revision 1.1  2000/03/03 15:15:33  lyon
...
INSTANTIATE_ONE( CathodeClusterHitLattice )

#include "FrameAccess/instantiate_one.h"

// Instantiate the storage helper
#include "StorageManagement/SMLatticeStorageHelper.h"
typedef SMLatticeStorageHelper<CathodeClusterHitLattice>
        CathodeClusterHitLatticeStorageHelper;
SM_REGISTER_STORAGE( CathodeClusterHitLatticeStorageHelper );

...
// $Id: T_Lattice_CathodeCluster-Hit.cc,v 1.1 2000/03/03 15:15:34 lyon Exp $
//
// Revision history
//
// $Log: T_Lattice_CathodeCluster-Hit.cc,v $
// Revision 1.1  2000/03/03 15:15:34  lyon
...
//------------------------------------------------------------//
typedef CalibratedCathodeHit _left_lattice_type_;
typedef DRCACorrectHit _right_lattice_type_;

...
// 
// $Id: CalibratedDRHit.cc,v 1.10 2001/11/29 22:12:10 bkh Exp $
//
...
{}
//                    
CalibratedDRHit::CalibratedDRHit(const CalibratedDRHit& calibratedDRHit)
               : CalibratedTimeHit(calibratedDRHit),
	          m_Wire          (calibratedDRHit.wire()),
		  m_Layer         (calibratedDRHit.layer()),
		  m_WireInLyr     (calibratedDRHit.wireInLyr()),
		  m_Charge        (calibratedDRHit.charge()),
		  m_Time          (calibratedDRHit.time()),
		  m_DistanceSeries (calibratedDRHit.m_DistanceSeries) ,
		  m_Weight        (calibratedDRHit.weight()),
		  m_QualHit       (calibratedDRHit.qualHit()),
		  m_nTDC          (calibratedDRHit.nTDC()),
		  m_earlyGap      (calibratedDRHit.earlyGap()),
		  m_lateGap       (calibratedDRHit.lateGap()),
  		  m_whichTDC      (calibratedDRHit.whichTDC()),
		  m_rawChargeTime (calibratedDRHit.rawChargeTime() )
{}
//

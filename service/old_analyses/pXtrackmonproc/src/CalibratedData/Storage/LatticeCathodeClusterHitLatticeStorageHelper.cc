...
//
// Package:     <package>
// Module:      LatticeCathodeClusterHitLatticeStorageHelper
// 
...
// $Id: LatticeCathodeClusterHitLatticeStorageHelper.cc,v 1.1 2000/03/03 15:12:54 lyon Exp $
//
// Revision history
//
// $Log: LatticeCathodeClusterHitLatticeStorageHelper.cc,v $

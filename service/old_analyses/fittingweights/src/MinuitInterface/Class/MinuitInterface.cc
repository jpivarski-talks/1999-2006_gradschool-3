...
// $Id: MinuitInterface.cc,v 1.5 2000/07/13 15:21:41 lyon Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: MinuitInterface.cc,v 1.5 2000/07/13 15:21:41 lyon Exp $";
...
extern "C" 
{
  ...
  void mncomd_(void* fcn, const FChar* command, FInteger* icond, void* futil,
	       FLength len);

...
// $Id: T_TRHelixExitMuonFitField.cc,v 1.2 2000/01/05 19:08:06 cdj Exp $
//
// Revision history
//
// $Log: T_TRHelixExitMuonFitField.cc,v $
// Revision 1.2  2000/01/05 19:08:06  cdj
...
INSTANTIATE_HELIX_FIELD( DBCandidate::kExitMuon, ExitMuon )

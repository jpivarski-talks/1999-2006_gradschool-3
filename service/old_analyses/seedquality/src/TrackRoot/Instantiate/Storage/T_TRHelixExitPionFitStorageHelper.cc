...
// $Id: T_TRHelixExitPionFitStorageHelper.cc,v 1.1 2000/01/05 18:47:04 cdj Exp $
//
// Revision history
//
// $Log: T_TRHelixExitPionFitStorageHelper.cc,v $
...
INSTANTIATE_HELIX_STORE(DBCandidate::kExitPion,ExitPion)

...
// Module:      PivarskiAddHitOperation
// 
...
// $Id: PivarskiAddHitOperation.cc,v 1.24 2003/10/15 19:11:33 mccann Exp $
//
// Revision history
//
// $Log: PivarskiAddHitOperation.cc,v $
// Revision 1.24  2003/10/15 19:11:33  mccann
// Wrapped excessive DEBUG printouts with m_printDiagnostics==true requirement
//
// Revision 1.23  2003/07/25 23:30:54  mccann
...
// * Moved track parameter update to PivarskiUpdateParamsOperation.
//
...
"PivarskiFilter.PivarskiAddHitOperation" ;
...
//
PivarskiAddHitOperation::PivarskiAddHitOperation( double aMaxHitChisq )
   : m_maxHitChisq( aMaxHitChisq ),
     m_removeHitsFromFit( false )
{
}

// PivarskiAddHitOperation::PivarskiAddHitOperation( const PivarskiAddHitOperation& rhs )
// {
...
PivarskiAddHitOperation::~PivarskiAddHitOperation()
{
}
...
//
// const PivarskiAddHitOperation& PivarskiAddHitOperation::operator=( const PivarskiAddHitOperation& rhs )
// {
//   if( this != &rhs ) {
...
DABoolean
PivarskiAddHitOperation::perform(
   ...
   const HIIntersectionSurface& aLastSurface ) const
{
   ...
   if( aHelixAfterOperation.helixType() == PivarskiHelix::kHelixType )
   {
      kalmanHelix = ( PivarskiHelix* ) &aHelixAfterOperation ;
   }
   else
   {
   ...
   STL_VECTOR( PivarskiHelix::HitAndLinkData ) hitsToAddToTrack ;
...
//       }
	 ...
	 hitsAdded = true ;
      ...
      PivarskiHelix::HitAndLinkData newHitAndLinkData(
...
void
PivarskiAddHitOperation::invert5x5SymMatrix( const HepSymMatrix& input,
					   HepSymMatrix& output )
{
   double tmp1[4][5] ;
   double tmp2[5][5] ;

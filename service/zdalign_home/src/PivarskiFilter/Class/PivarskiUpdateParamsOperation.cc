...
// $Id: PivarskiUpdateParamsOperation.cc,v 1.7 2001/03/27 06:37:23 wsun Exp $
//
// Revision history
//
// $Log: PivarskiUpdateParamsOperation.cc,v $
...
//
PivarskiUpdateParamsOperation::PivarskiUpdateParamsOperation(
...
// PivarskiUpdateParamsOperation::PivarskiUpdateParamsOperation( const PivarskiUpdateParamsOperation& rhs )
// {
...
//
// const PivarskiUpdateParamsOperation& PivarskiUpdateParamsOperation::operator=( const PivarskiUpdateParamsOperation& rhs )
// {
//   if( this != &rhs ) {
...
DABoolean
PivarskiUpdateParamsOperation::perform(

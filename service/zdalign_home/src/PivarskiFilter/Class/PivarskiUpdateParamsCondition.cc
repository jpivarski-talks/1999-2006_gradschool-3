...
// $Id: PivarskiUpdateParamsCondition.cc,v 1.7 2001/03/27 06:37:02 wsun Exp $
//
// Revision history
//
// $Log: PivarskiUpdateParamsCondition.cc,v $
...
static const char* const kFacilityString = "PivarskiFilter.PivarskiUpdateParamsCondition" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: PivarskiUpdateParamsCondition.cc,v 1.7 2001/03/27 06:37:02 wsun Exp $";
...
//
PivarskiUpdateParamsCondition::PivarskiUpdateParamsCondition()
   : m_ignoreNumberOfHits( false )
{
}

// PivarskiUpdateParamsCondition::PivarskiUpdateParamsCondition( const PivarskiUpdateParamsCondition& rhs )
// {
...
//
// const PivarskiUpdateParamsCondition& PivarskiUpdateParamsCondition::operator=( const PivarskiUpdateParamsCondition& rhs )
// {
//   if( this != &rhs ) {
...
DABoolean
PivarskiUpdateParamsCondition::satisfied( const HIHelix& aHelix,
					HIIntersectionSurface& aSurface ) const
{
   ...
   if( kalmanHelix->numberOfNewHitsInFit() > 0 )
   {
	 ...
	 kalmanHelix->newErrorMatrix()(
	    PivarskiHelix::kCurvature, PivarskiHelix::kCurvature ) ;
      double newSigma2Phi0 =
	 kalmanHelix->newErrorMatrix()(
	    PivarskiHelix::kPhi0, PivarskiHelix::kPhi0 ) ;
      double newSigma2D0 =
	 kalmanHelix->newErrorMatrix()(
	    PivarskiHelix::kD0, PivarskiHelix::kD0 ) ;

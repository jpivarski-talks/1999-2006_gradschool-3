...
// $Id: PivarskiCandidateQualityStorageHelper.cc,v 1.6 2001/08/17 21:45:12 wsun Exp $
//
// Revision history
//
// $Log: PivarskiCandidateQualityStorageHelper.cc,v $
...
#include "PivarskiFilter/Storage/PivarskiCandidateQualityStorageHelper.h"
...
static const char* const kFacilityString = "PivarskiFilter.PivarskiCandidateQualityStorageHelper" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: PivarskiCandidateQualityStorageHelper.cc,v 1.6 2001/08/17 21:45:12 wsun Exp $";
...
#endif
PivarskiCandidateQualityStorageHelper<H>::PivarskiCandidateQualityStorageHelper()
{
   //registration of the different versions
   // NOTE: version number is determined by the order in which the
   // methods are registered
   registerVersion( &PivarskiCandidateQualityStorageHelper::deliverV1 );
   registerVersion( &PivarskiCandidateQualityStorageHelper::deliverV2 );
   registerVersion( &PivarskiCandidateQualityStorageHelper::deliverV3 );
}

// PivarskiCandidateQualityStorageHelper::PivarskiCandidateQualityStorageHelper( const PivarskiCandidateQualityStorageHelper& rhs )
// {
...
//PivarskiCandidateQualityStorageHelper::~PivarskiCandidateQualityStorageHelper()
//{
//}
...
//
// const PivarskiCandidateQualityStorageHelper& PivarskiCandidateQualityStorageHelper::operator=( const PivarskiCandidateQualityStorageHelper& rhs )
// {
//   if( this != &rhs ) {
...
#endif
void 
PivarskiCandidateQualityStorageHelper<H>::implementStore( 
   SMSinkStream& iSink,
...
template < DBCandidate::Hypo H >
#endif
PivarskiCandidateQuality<H>* 
PivarskiCandidateQualityStorageHelper<H>::deliverV1( SMSourceStream& iSource)
{
   
   PivarskiCandidateQuality<H>::Identifier identifier; 
   double chiSquare; 
   ...
   return make( PivarskiCandidateQuality<H>( 
      identifier,  
      chiSquare,  
      degreesOfFreedom,  
      numberHits,  
...
#endif
PivarskiCandidateQuality<H>* 
PivarskiCandidateQualityStorageHelper<H>::deliverV2( SMSourceStream& iSource)
{
...
#endif
PivarskiCandidateQuality<H>* 
PivarskiCandidateQualityStorageHelper<H>::deliverV3( SMSourceStream& iSource)
{
...
template < DBCandidate::Hypo H >
#endif
const PivarskiCandidateQuality<H>& 
PivarskiCandidateQualityStorageHelper<H>::getDefault() const
{
   //give constructor unique values to allow test of store and deliver 
   // functions
   static const PivarskiCandidateQuality<H> temp(
      PivarskiCandidateQuality<H>::Identifier ( 1 ), // identifier 
      double ( 2 ), // chiSquare 
...
#endif
DABoolean 
PivarskiCandidateQualityStorageHelper<H>::compare( 
   const PivarskiCandidateQuality<H>* iNewData, 
   const PivarskiCandidateQuality<H>& iOldData ) const
{
   //write a comparison operation if operator== doesn't exist for PivarskiCandidateQuality
...
//PivarskiCandidateQuality*
//SMStorageHelper<PivarskiCandidateQuality>::make( const PivarskiCandidateQuality& iTempData ) const
//{
   //change this line if PivarskiCandidateQuality does not have a copy constructor
//   return new PivarskiCandidateQuality( iTempData );
//}

// //------------------------------------------------------
// // DO NOT DELETE 
// SM_REGISTER_STORAGE( PivarskiCandidateQualityStorageHelper );

// #include "StorageManagement/SMDeliverer.h"
// SM_REGISTER_VERSION_DEF( PivarskiCandidateQualityStorageHelper, PivarskiCandidateQuality )

// //this is done to create a TypeTag and its name
// #include "FrameAccess/instantiate_macros.h"
// INSTANTIATE_ONE(PivarskiCandidateQuality)
// #include "StorageManagement/instantiate_one_typetag.h"

// #include "StorageManagement/Template/SMStorageHelper.cc"
// template class SMStorageHelper<PivarskiCandidateQuality>;

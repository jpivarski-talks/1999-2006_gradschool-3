...
#include "PivarskiFilter/Storage/Template/PivarskiCandidateQualityStorageHelper.cc"
...
typedef PivarskiCandidateQuality< part_type > _one_element_; \
template class PivarskiCandidateQualityStorageHelper< part_type > ;

#else
#define INSTANTIATE_QUALITY_STORE(part_type)\
template class SMStorageHelper<PivarskiCandidateQuality<part_type> >; \
typedef PivarskiCandidateQuality< part_type > _one_element_; \
template class PivarskiCandidateQualityStorageHelper< part_type > ;
#endif

...
typedef PivarskiCandidateQuality< part_type > Pivarski ## part_name ## Quality;\
INSTANTIATE_MANY( Pivarski ## part_name ## Quality )  \
INSTANTIATE_ONE( Pivarski ## part_name ## Quality )  \
static SMFAPtrTableStorageHelper<Pivarski ## part_name ## Quality > \
s_ ## FATablePivarski ## part_name ## Quality;\
static PivarskiCandidateQualityStorageHelper<part_type > \
s_ ## part_name ## PivarskiFitQuality ;

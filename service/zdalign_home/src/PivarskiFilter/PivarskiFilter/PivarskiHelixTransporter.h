...
// 
/**\class PivarskiHelixTransporter PivarskiHelixTransporter.h PivarskiFilter/PivarskiHelixTransporter.h
...
// $Id: PivarskiHelixTransporter.h,v 1.1 2001/03/27 06:33:40 wsun Exp $
//
// Revision history
//
// $Log: PivarskiHelixTransporter.h,v $
...
class PivarskiHelixTransporter
{
   ...
   public:
      ...
      PivarskiHelixTransporter( Frame& aFrame );
      virtual ~PivarskiHelixTransporter();
   ...
   private:
      // ---------- Constructors and destructor ----------------
      PivarskiHelixTransporter( const PivarskiHelixTransporter& ); // stop default

      // ---------- assignment operator(s) ---------------------
      const PivarskiHelixTransporter& operator=( const PivarskiHelixTransporter& ); // stop default
...
//# include "PivarskiFilter/Template/PivarskiHelixTransporter.cc"
//#endif

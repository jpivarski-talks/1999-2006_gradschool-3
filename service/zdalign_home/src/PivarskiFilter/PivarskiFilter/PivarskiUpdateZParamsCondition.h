...
// $Id: PivarskiUpdateZParamsCondition.h,v 1.2 1999/08/27 20:43:05 wsun Exp $
//
// Revision history
//
// $Log: PivarskiUpdateZParamsCondition.h,v $
...
class PivarskiUpdateZParamsCondition : public HICondition
{
   ...
   public:
      ...
      PivarskiUpdateZParamsCondition( double aErr2Z0 = 0.01,
				    double aErr2CotTheta = 1.,
				    double aDFracCotTheta = 2. ) ;
      virtual ~PivarskiUpdateZParamsCondition();
   ...
   private:
      // ---------- Constructors and destructor ----------------
      PivarskiUpdateZParamsCondition( const PivarskiUpdateZParamsCondition& ); // stop default

      // ---------- assignment operator(s) ---------------------
      const PivarskiUpdateZParamsCondition& operator=( const PivarskiUpdateZParamsCondition& ); // stop default
...
//# include "PivarskiFilter/Template/PivarskiUpdateZParamsCondition.cc"
//#endif

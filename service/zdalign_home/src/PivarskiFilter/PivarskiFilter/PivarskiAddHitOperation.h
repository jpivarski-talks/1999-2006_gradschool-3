...
// 
// Description: HIHelixOperation subclass for adding a hit in the Pivarski
...
// $Id: PivarskiAddHitOperation.h,v 1.6 2001/03/27 06:39:31 wsun Exp $
//
// Revision history
//
// $Log: PivarskiAddHitOperation.h,v $
...
class PivarskiAddHitOperation : public HIHelixOperation
{
   ...
   public:
      ...
      PivarskiAddHitOperation( double aMaxHitChisq = 15. ) ;

      virtual ~PivarskiAddHitOperation();
   ...
   private:
      // ---------- Constructors and destructor ----------------
      PivarskiAddHitOperation( const PivarskiAddHitOperation& );
      // stop default

      // ---------- assignment operator(s) ---------------------
      const PivarskiAddHitOperation& operator=(
	 const PivarskiAddHitOperation& ); // stop default
...
//# include "PivarskiFilter/Template/PivarskiAddHitOperation.cc"
//#endif

...
// $Id: PivarskiCandidateQuality.h,v 1.6 2001/01/05 05:33:08 lyon Exp $
//
// Revision history
//
// $Log: PivarskiCandidateQuality.h,v $
...
#endif
class PivarskiCandidateQuality : public TRTrackCandidateFitQuality< H >
{
   ...
   public:
      ...
      PivarskiCandidateQuality( Identifier identifier,
			      double chiSquare,
	 ...
	 m_pullOfNextWorstHit(             pullOfNextWorstHit )
{
      ...
      virtual ~PivarskiCandidateQuality() ;
   ...
   private:
      ...
      const PivarskiCandidateQuality& operator=( const PivarskiCandidateQuality& );

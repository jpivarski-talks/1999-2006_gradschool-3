...
// $Id: McCannProd.h,v 1.15 2003/04/17 17:05:10 bkh Exp $
//
// Revision history
//
// $Log: McCannProd.h,v $
...
class McCannProd : public Producer
{
   ...
   public:
      ...
      McCannProd( void );                      // anal1 
      virtual ~McCannProd();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor -----------------
      McCannProd( const McCannProd& );

      // ------------ assignment operator(s) ----------------------
      const McCannProd& operator=( const McCannProd& );

      // ------------ private member functions --------------------
      ProxyBase* makeMcCannTrackFitterProxy() ;

...
// $Id: McCannCandidateQualityProxy.cc,v 1.11 2003/07/25 23:34:53 mccann Exp $
//
// Revision history
//
// $Log: McCannCandidateQualityProxy.cc,v $
...
//
static const char* const kFacilityString = "McCannCandidateQualityProxy" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: McCannCandidateQualityProxy.cc,v 1.11 2003/07/25 23:34:53 mccann Exp $";
...
#endif
McCannCandidateQualityProxy< H >::McCannCandidateQualityProxy()
...
// McCannCandidateQualityProxy::McCannCandidateQualityProxy( const McCannCandidateQualityProxy& iproxy )
// {
//   *this = iproxy;
// }
...
//
// const McCannCandidateQualityProxy& McCannCandidateQualityProxy::operator=( const McCannCandidateQualityProxy& iproxy )
// {
//   if( this != &iproxy ) {
...
#endif
void
McCannCandidateQualityProxy< H >::invalidateCache()
{
   if ( 0 != m_ptrTable ) {
      (*m_ptrTable).eraseAll() ;
   }
...
template < DBCandidate::Hypo H >
#endif
const typename McCannCandidateQualityProxy< H >::value_type*
McCannCandidateQualityProxy< H >::faultHandler( const Record& iRecord,
						const DataKey& iKey )
{
   ...
   // the corresponding McCannHelix objects have the same identifier.
   ...
   for( ; helixItr != helixEnd ; ++helixItr )
   {
	    ...
	    TRSubdetectorLists::HitTypes( j ) ) )
	 {
      ...
      McCannCandidateQuality< H >* tmp = new McCannCandidateQuality< H >(
                  ( *helixItr )->identifier(),
                  ( *helixItr )->chisq(),
                  ndof,
...
//void
//McCannCandidateQualityProxy::boundMethod( const Record& iRecord )
//{

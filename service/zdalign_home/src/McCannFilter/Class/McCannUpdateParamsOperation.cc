...
// $Id: McCannUpdateParamsOperation.cc,v 1.7 2001/03/27 06:37:23 wsun Exp $
//
// Revision history
//
// $Log: McCannUpdateParamsOperation.cc,v $
...
//
McCannUpdateParamsOperation::McCannUpdateParamsOperation(
...
// McCannUpdateParamsOperation::McCannUpdateParamsOperation( const McCannUpdateParamsOperation& rhs )
// {
...
//
// const McCannUpdateParamsOperation& McCannUpdateParamsOperation::operator=( const McCannUpdateParamsOperation& rhs )
// {
//   if( this != &rhs ) {
...
DABoolean
McCannUpdateParamsOperation::perform(

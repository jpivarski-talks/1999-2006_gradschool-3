...
// $Id: McCannHelixTransporter.cc,v 1.3 2003/09/10 21:31:56 wsun Exp $
//
// Revision history
//
// $Log: McCannHelixTransporter.cc,v $
...
#include "McCannFilter/McCannHelixTransporter.h"
...
static const char* const kFacilityString = "McCannFilter.McCannHelixTransporter" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: McCannHelixTransporter.cc,v 1.3 2003/09/10 21:31:56 wsun Exp $";
...
//
McCannHelixTransporter::McCannHelixTransporter( Frame& aFrame )
   : m_surfacesOK( true ),
...
// McCannHelixTransporter::McCannHelixTransporter( const McCannHelixTransporter& rhs )
// {
...
McCannHelixTransporter::~McCannHelixTransporter()
{
...
//
// const McCannHelixTransporter& McCannHelixTransporter::operator=( const McCannHelixTransporter& rhs )
// {
//   if( this != &rhs ) {
...
DABoolean
McCannHelixTransporter::transportThroughMaterial(
...
void
McCannHelixTransporter::generateSurfaces( Frame& theFrame )
{

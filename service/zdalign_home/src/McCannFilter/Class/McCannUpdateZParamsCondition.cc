...
// $Id: McCannUpdateZParamsCondition.cc,v 1.7 1999/08/30 21:55:52 wsun Exp $
//
// Revision history
//
// $Log: McCannUpdateZParamsCondition.cc,v $
...
static const char* const kFacilityString = "McCannUpdateZParamsCondition" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: McCannUpdateZParamsCondition.cc,v 1.7 1999/08/30 21:55:52 wsun Exp $";
...
//
McCannUpdateZParamsCondition::McCannUpdateZParamsCondition(
   double aErr2Z0,
...
// McCannUpdateZParamsCondition::McCannUpdateZParamsCondition( const McCannUpdateZParamsCondition& rhs )
// {
...
//
// const McCannUpdateZParamsCondition& McCannUpdateZParamsCondition::operator=( const McCannUpdateZParamsCondition& rhs )
// {
//   if( this != &rhs ) {
...
DABoolean
McCannUpdateZParamsCondition::satisfied(
   ...
   HIIntersectionSurface& aSurface ) const
{
   ...
   if( kalmanHelix->numberOfNewHitsInFit() > 0 )
   {
	 ...
	 kalmanHelix->newErrorMatrix()(
	    McCannHelix::kCotTheta, McCannHelix::kCotTheta ) ;
      double newSigma2Z0 =
	 kalmanHelix->newErrorMatrix()(
	    McCannHelix::kZ0, McCannHelix::kZ0 ) ;

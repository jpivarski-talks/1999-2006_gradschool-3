...
// $Id: McCannHelix.cc,v 1.18 2002/04/27 17:42:37 cleo3 Exp $
//
// Revision history
//
// $Log: McCannHelix.cc,v $
...
static const char* const kFacilityString = "McCannFilter.McCannHelix" ;
const string McCannHelix::kHelixType = "McCannHelix" ;
//
...
McCannHelix::McCannHelix( const KTHelix& aHelix,
			  GeV aMass,
			  Meters anArcLength,
			  Identifier aId,
...
void
McCannHelix::setNewHitsOnTrack( const STL_VECTOR( HitAndLinkData )& aHits )
{
   m_newHitsOnTrack = aHits ;
}

void
McCannHelix::updateHitsOnTrack()
{
...
void
McCannHelix::updateTrackParameters()
{
...
void
McCannHelix::clearFitInfoChanges()
{
...
KTHelix::MoveStatus
McCannHelix::moveToReferencePoint( const HepPoint3D& aPoint,
...
KTHelix::MoveStatus
McCannHelix::moveToLine( const HepPoint3D& aPoint,
...
KTHelix::MoveStatus
McCannHelix::moveToZPosition( const Meters aZPosition,
			      const MoveDirection aDirection )
{
   KTHelix oldHelix( *this, false ) ;
...
KTHelix::MoveStatus
McCannHelix:: moveToPlane( const HepPoint3D&  aPoint,
...
KTHelix::MoveStatus
McCannHelix::moveToRadius( const Meters aRadius,
			   const MoveDirection aDirection )
{
   KTHelix oldHelix( *this, false ) ;
...
KTHelix::MoveStatus
McCannHelix::moveToCylinder( const HepPoint3D& aCenter,
			     const HepVector3D& aDirCosine,
...
KTHelix::MoveStatus
McCannHelix::moveByArcLength( Meters aArcLength )
{
   KTHelix oldHelix( *this, false ) ;
...
void
McCannHelix::transportCorrections()
{
...
void
McCannHelix::transportCorrections( const HepMatrix& aTransportMatrix )
{
...
void
McCannHelix::transportCorrectionsDedx( const HepVector& aTransportVector )
{
...
int
McCannHelix::numberOfNewHitsInFit() const
{

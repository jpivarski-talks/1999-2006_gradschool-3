...
// $Id: McCannHelix.h,v 1.18 2002/04/27 17:42:39 cleo3 Exp $
//
// Revision history
//
// $Log: McCannHelix.h,v $
...
class McCannHelix : public HIFitHelix
{
   ...
   public:
      ...
      McCannHelix();
      //McCannHelix( const McCannHelix& );
      McCannHelix( const KTHelix& aHelix,
      ...
      //const McCannHelix& operator=( const McCannHelix& );
	 ...
	 m_transportNewErrorMatrix = true ;
      ...
      // The McCann filter is allowed to throw away only so many hits.
...
//# include "McCannFilter/Template/HIFitHelix.cc"
//#endif

...
// 
// Description: HIHelixOperation subclass for adding a hit in the McCann
...
// $Id: McCannAddHitOperation.h,v 1.6 2001/03/27 06:39:31 wsun Exp $
//
// Revision history
//
// $Log: McCannAddHitOperation.h,v $
...
class McCannAddHitOperation : public HIHelixOperation
{
   ...
   public:
      ...
      McCannAddHitOperation( double aMaxHitChisq = 15. ) ;

      virtual ~McCannAddHitOperation();
   ...
   private:
      // ---------- Constructors and destructor ----------------
      McCannAddHitOperation( const McCannAddHitOperation& );
      // stop default

      // ---------- assignment operator(s) ---------------------
      const McCannAddHitOperation& operator=(
	 const McCannAddHitOperation& ); // stop default
...
//# include "McCannFilter/Template/McCannAddHitOperation.cc"
//#endif

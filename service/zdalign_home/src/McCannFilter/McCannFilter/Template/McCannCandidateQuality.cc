...
// $Id: McCannCandidateQuality.cc,v 1.5 2001/01/05 05:33:13 lyon Exp $
//
// Revision history
//
// $Log: McCannCandidateQuality.cc,v $
...
// Forgot to update McCannCandidateQuality.cc to new TRTrackFitQuality.
//
...
static const char* const kIdString  = "$Id: McCannCandidateQuality.cc,v 1.5 2001/01/05 05:33:13 lyon Exp $";
...
#endif
McCannCandidateQuality< H >::McCannCandidateQuality(
...
#endif /* KALMANFILTER_McCannCandidateQuality_CC */

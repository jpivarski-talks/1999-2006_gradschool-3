...
// 
/**\class McCannHelixTransporter McCannHelixTransporter.h McCannFilter/McCannHelixTransporter.h
...
// $Id: McCannHelixTransporter.h,v 1.1 2001/03/27 06:33:40 wsun Exp $
//
// Revision history
//
// $Log: McCannHelixTransporter.h,v $
...
class McCannHelixTransporter
{
   ...
   public:
      ...
      McCannHelixTransporter( Frame& aFrame );
      virtual ~McCannHelixTransporter();
   ...
   private:
      // ---------- Constructors and destructor ----------------
      McCannHelixTransporter( const McCannHelixTransporter& ); // stop default

      // ---------- assignment operator(s) ---------------------
      const McCannHelixTransporter& operator=( const McCannHelixTransporter& ); // stop default
...
//# include "McCannFilter/Template/McCannHelixTransporter.cc"
//#endif

...
// $Id: McCannCandidateQualityStorageHelper.cc,v 1.6 2001/08/17 21:45:12 wsun Exp $
//
// Revision history
//
// $Log: McCannCandidateQualityStorageHelper.cc,v $
...
static const char* const kFacilityString = "McCannFilter.McCannCandidateQualityStorageHelper" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: McCannCandidateQualityStorageHelper.cc,v 1.6 2001/08/17 21:45:12 wsun Exp $";
...
#endif
McCannCandidateQualityStorageHelper<H>::McCannCandidateQualityStorageHelper()
{
   //registration of the different versions
   // NOTE: version number is determined by the order in which the
   // methods are registered
   registerVersion( &McCannCandidateQualityStorageHelper::deliverV1 );
   registerVersion( &McCannCandidateQualityStorageHelper::deliverV2 );
   registerVersion( &McCannCandidateQualityStorageHelper::deliverV3 );
}

// McCannCandidateQualityStorageHelper::McCannCandidateQualityStorageHelper( const McCannCandidateQualityStorageHelper& rhs )
// {
...
//McCannCandidateQualityStorageHelper::~McCannCandidateQualityStorageHelper()
//{
//}
...
//
// const McCannCandidateQualityStorageHelper& McCannCandidateQualityStorageHelper::operator=( const McCannCandidateQualityStorageHelper& rhs )
// {
//   if( this != &rhs ) {
...
#endif
void 
McCannCandidateQualityStorageHelper<H>::implementStore( 
   SMSinkStream& iSink,
...
template < DBCandidate::Hypo H >
#endif
McCannCandidateQuality<H>* 
McCannCandidateQualityStorageHelper<H>::deliverV1( SMSourceStream& iSource)
{
   
   McCannCandidateQuality<H>::Identifier identifier; 
   double chiSquare; 
   ...
   return make( McCannCandidateQuality<H>( 
      identifier,  
      chiSquare,  
      degreesOfFreedom,  
      numberHits,  
...
#endif
McCannCandidateQuality<H>* 
McCannCandidateQualityStorageHelper<H>::deliverV2( SMSourceStream& iSource)
{
...
#endif
McCannCandidateQuality<H>* 
McCannCandidateQualityStorageHelper<H>::deliverV3( SMSourceStream& iSource)
{
...
template < DBCandidate::Hypo H >
#endif
const McCannCandidateQuality<H>& 
McCannCandidateQualityStorageHelper<H>::getDefault() const
{
   //give constructor unique values to allow test of store and deliver 
   // functions
   static const McCannCandidateQuality<H> temp(
      McCannCandidateQuality<H>::Identifier ( 1 ), // identifier 
      double ( 2 ), // chiSquare 
...
#endif
DABoolean 
McCannCandidateQualityStorageHelper<H>::compare( 
   const McCannCandidateQuality<H>* iNewData, 
   const McCannCandidateQuality<H>& iOldData ) const
{
   //write a comparison operation if operator== doesn't exist for McCannCandidateQuality
...
//McCannCandidateQuality*
//SMStorageHelper<McCannCandidateQuality>::make( const McCannCandidateQuality& iTempData ) const
//{
   //change this line if McCannCandidateQuality does not have a copy constructor
//   return new McCannCandidateQuality( iTempData );
//}

// //------------------------------------------------------
// // DO NOT DELETE 
// SM_REGISTER_STORAGE( McCannCandidateQualityStorageHelper );

// #include "StorageManagement/SMDeliverer.h"
// SM_REGISTER_VERSION_DEF( McCannCandidateQualityStorageHelper, McCannCandidateQuality )

// //this is done to create a TypeTag and its name
// #include "FrameAccess/instantiate_macros.h"
// INSTANTIATE_ONE(McCannCandidateQuality)
// #include "StorageManagement/instantiate_one_typetag.h"

// #include "StorageManagement/Template/SMStorageHelper.cc"
// template class SMStorageHelper<McCannCandidateQuality>;

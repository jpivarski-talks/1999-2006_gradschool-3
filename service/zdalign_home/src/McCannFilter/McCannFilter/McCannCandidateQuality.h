...
// $Id: McCannCandidateQuality.h,v 1.6 2001/01/05 05:33:08 lyon Exp $
//
// Revision history
//
// $Log: McCannCandidateQuality.h,v $
...
#endif
class McCannCandidateQuality : public TRTrackCandidateFitQuality< H >
{
   ...
   public:
      ...
      McCannCandidateQuality( Identifier identifier,
			      double chiSquare,
	 ...
	 m_pullOfNextWorstHit(             pullOfNextWorstHit )
{
      ...
      virtual ~McCannCandidateQuality() ;
   ...
   private:
      ...
      const McCannCandidateQuality& operator=( const McCannCandidateQuality& );

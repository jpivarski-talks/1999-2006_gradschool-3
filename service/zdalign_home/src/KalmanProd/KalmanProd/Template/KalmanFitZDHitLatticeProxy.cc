...
// $Id: KalmanFitZDHitLatticeProxy.cc,v 1.2 2003/07/25 23:34:53 mccann Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanFitZDHitLatticeProxy.cc,v 1.2 2003/07/25 23:34:53 mccann Exp $";

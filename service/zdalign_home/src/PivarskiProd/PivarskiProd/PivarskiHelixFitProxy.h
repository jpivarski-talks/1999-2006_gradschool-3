...
// 
// Description: Proxy to "handle" PivarskiHelixFit
//
// Usage:
//    <usage>
//
...
// $Id: PivarskiHelixFitProxy.h,v 1.1.1.1 1999/09/10 21:58:56 wsun Exp $
//
// Revision history
//
// $Log: PivarskiHelixFitProxy.h,v $
   ...
   public ProxyTemplate< FAPtrTable< TRHelixCandidateFit< H > > >
{
   ...
   public:
      ...
      PivarskiHelixFitProxy();
      virtual ~PivarskiHelixFitProxy();
   ...
   private:
      // Constructors and destructor
      PivarskiHelixFitProxy( const PivarskiHelixFitProxy& );

      // assignment operator(s)
      const PivarskiHelixFitProxy& operator=( const PivarskiHelixFitProxy& );

...
// $Id: PivarskiFitDRHitLatticeProxy.h,v 1.1.1.1 1999/09/10 21:58:56 wsun Exp $
//
// Revision history
//
// $Log: PivarskiFitDRHitLatticeProxy.h,v $
...
#endif
class PivarskiFitDRHitLatticeProxy :
				 ...
				 TrackFitDRHitLink > >
{
   ...
   public:
	 ...
	 TrackFitDRHitLink > value_type;
      ...
      PivarskiFitDRHitLatticeProxy();
      virtual ~PivarskiFitDRHitLatticeProxy();
   ...
   private:
      // Constructors and destructor
      PivarskiFitDRHitLatticeProxy( const PivarskiFitDRHitLatticeProxy& );

      // assignment operator(s)
      const PivarskiFitDRHitLatticeProxy& operator=( const PivarskiFitDRHitLatticeProxy& );
      ...
      // data members
      value_type* m_PivarskiFitDRHitLattice ;

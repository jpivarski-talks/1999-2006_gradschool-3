...
// $Id: PivarskiFitSVZHitLatticeProxy.h,v 1.1.1.1 1999/09/10 21:58:56 wsun Exp $
//
// Revision history
//
// $Log: PivarskiFitSVZHitLatticeProxy.h,v $
...
#endif
class PivarskiFitSVZHitLatticeProxy :
				 ...
				 TrackFitSVZHitLink > >
{
   ...
   public:
	 ...
	 TrackFitSVZHitLink > value_type;
      ...
      PivarskiFitSVZHitLatticeProxy();
      virtual ~PivarskiFitSVZHitLatticeProxy();
   ...
   private:
      // Constructors and destructor
      PivarskiFitSVZHitLatticeProxy( const PivarskiFitSVZHitLatticeProxy& );

      // assignment operator(s)
      const PivarskiFitSVZHitLatticeProxy& operator=( const PivarskiFitSVZHitLatticeProxy& );
      ...
      // data members
      value_type* m_PivarskiFitSVZHitLattice ;

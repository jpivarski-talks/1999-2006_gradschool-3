...
// $Id: PivarskiProd.h,v 1.15 2003/04/17 17:05:10 bkh Exp $
//
// Revision history
//
// $Log: PivarskiProd.h,v $
// Revision 1.15  2003/04/17 17:05:10  bkh
...
class PivarskiProd : public Producer
{
   ...
   public:
      ...
      PivarskiProd( void );                      // anal1 
      virtual ~PivarskiProd();                   // anal5 
      ...
      DABoolean useZDStereoUHits() const { return m_useZDStereoUHits.value(); }
      DABoolean useZDStereoVHits() const { return m_useZDStereoVHits.value(); }
   ...
   private:
      // ------------ Constructors and destructor -----------------
      PivarskiProd( const PivarskiProd& );

      // ------------ assignment operator(s) ----------------------
      const PivarskiProd& operator=( const PivarskiProd& );

      // ------------ private member functions --------------------
      ProxyBase* makePivarskiTrackFitterProxy() ;

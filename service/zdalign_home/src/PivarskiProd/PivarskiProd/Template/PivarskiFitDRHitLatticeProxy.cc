...
// Module:      PivarskiFitDRHitLatticeProxy
// 
...
// $Id: PivarskiFitDRHitLatticeProxy.cc,v 1.6 2002/06/17 20:01:00 cleo3 Exp $
//
// Revision history
//
// $Log: PivarskiFitDRHitLatticeProxy.cc,v $
...
//
static const char* const kFacilityString = "PivarskiFitDRHitLatticeProxy" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: PivarskiFitDRHitLatticeProxy.cc,v 1.6 2002/06/17 20:01:00 cleo3 Exp $";
...
#endif
PivarskiFitDRHitLatticeProxy< H >::PivarskiFitDRHitLatticeProxy()
   : m_PivarskiFitDRHitLattice( 0 )
{
}

// PivarskiFitDRHitLatticeProxy::PivarskiFitDRHitLatticeProxy( const PivarskiFitDRHitLatticeProxy& iproxy )
// {
//   *this = iproxy;
// }
...
PivarskiFitDRHitLatticeProxy< H >::~PivarskiFitDRHitLatticeProxy()
{
   delete m_PivarskiFitDRHitLattice ;
}

//
// assignment operators
//
// const PivarskiFitDRHitLatticeProxy& PivarskiFitDRHitLatticeProxy::operator=( const PivarskiFitDRHitLatticeProxy& iproxy )
// {
//   if( this != &iproxy ) {
...
#endif
void
PivarskiFitDRHitLatticeProxy< H >::invalidateCache()
{
   delete m_PivarskiFitDRHitLattice ;
   m_PivarskiFitDRHitLattice = 0 ;
}
...
template < DBCandidate::Hypo H >
#endif
const typename PivarskiFitDRHitLatticeProxy< H >::value_type*
PivarskiFitDRHitLatticeProxy< H >::faultHandler( const Record& iRecord,
					       const DataKey& iKey )
{
   // be assertive: there should be no cached data at this point, else
   // it's a programming error
   assert( 0 == m_PivarskiFitDRHitLattice );
   ...
   if( fitter->useDRAxialHits() || 
	 ...
	 m_PivarskiFitDRHitLattice =  new value_type( candHelices,
						    drHits,
	 ...
	 for( ; helixItr != helixEnd ; ++helixItr )
	 {
	    ...
	    for( ; hitIter != last ; ++hitIter )
	    {
		   ...
		   CalibratedHit::DR )
	       {
		  if( m_PivarskiFitDRHitLattice->connect(
   ...
   if( 0 == m_PivarskiFitDRHitLattice ) {
   ...
   return ( m_PivarskiFitDRHitLattice ) ;
}
...
//void
//PivarskiFitDRHitLatticeProxy::boundMethod( const Record& iRecord )
//{

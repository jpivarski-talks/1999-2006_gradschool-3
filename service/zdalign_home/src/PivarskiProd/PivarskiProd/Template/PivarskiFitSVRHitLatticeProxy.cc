...
// $Id: PivarskiFitSVRHitLatticeProxy.cc,v 1.7 2003/04/17 17:05:12 bkh Exp $
//
// Revision history
//
// $Log: PivarskiFitSVRHitLatticeProxy.cc,v $
...
//
static const char* const kFacilityString = "PivarskiFitSVRHitLatticeProxy" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: PivarskiFitSVRHitLatticeProxy.cc,v 1.7 2003/04/17 17:05:12 bkh Exp $";
...
#endif
PivarskiFitSVRHitLatticeProxy< H >::PivarskiFitSVRHitLatticeProxy()
   : m_PivarskiFitSVRHitLattice( 0 )
{
}

// PivarskiFitSVRHitLatticeProxy::PivarskiFitSVRHitLatticeProxy( const PivarskiFitSVRHitLatticeProxy& iproxy )
// {
//   *this = iproxy;
// }
...
PivarskiFitSVRHitLatticeProxy< H >::~PivarskiFitSVRHitLatticeProxy()
{
   delete m_PivarskiFitSVRHitLattice ;
}

//
// assignment operators
//
// const PivarskiFitSVRHitLatticeProxy& PivarskiFitSVRHitLatticeProxy::operator=( const PivarskiFitSVRHitLatticeProxy& iproxy )
// {
//   if( this != &iproxy ) {
...
#endif
void
PivarskiFitSVRHitLatticeProxy< H >::invalidateCache()
{
   delete m_PivarskiFitSVRHitLattice ;
   m_PivarskiFitSVRHitLattice = 0 ;
}
...
template < DBCandidate::Hypo H >
#endif
const typename PivarskiFitSVRHitLatticeProxy< H >::value_type*
PivarskiFitSVRHitLatticeProxy< H >::faultHandler( const Record& iRecord,
						const DataKey& iKey )
{
   ...
   assert( 0 == m_PivarskiFitSVRHitLattice );
   ...
   if ( fitter->useSVRPhiHits() ) {
	 ...
	 m_PivarskiFitSVRHitLattice =  new value_type( candHelices,
						     svrHits,
	 ...
	 for( ; helixItr != helixEnd ; ++helixItr )
	 {
	    ...
	    for( ; hitIter != last ; ++hitIter )
	    {
		   ...
		   CalibratedHit::SVR )
	       {
		  if( m_PivarskiFitSVRHitLattice->connect(
   ...
   if( 0 == m_PivarskiFitSVRHitLattice ) {
   ...
   return ( m_PivarskiFitSVRHitLattice ) ;
}
...
//void
//PivarskiFitSVRHitLatticeProxy::boundMethod( const Record& iRecord )
//{

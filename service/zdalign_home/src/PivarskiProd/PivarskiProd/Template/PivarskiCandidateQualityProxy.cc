...
// $Id: PivarskiCandidateQualityProxy.cc,v 1.11 2003/07/25 23:34:53 mccann Exp $
//
// Revision history
//
// $Log: PivarskiCandidateQualityProxy.cc,v $
// Revision 1.11  2003/07/25 23:34:53  mccann
...
//
static const char* const kFacilityString = "PivarskiCandidateQualityProxy" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: PivarskiCandidateQualityProxy.cc,v 1.11 2003/07/25 23:34:53 mccann Exp $";
...
#endif
PivarskiCandidateQualityProxy< H >::PivarskiCandidateQualityProxy()
...
// PivarskiCandidateQualityProxy::PivarskiCandidateQualityProxy( const PivarskiCandidateQualityProxy& iproxy )
// {
//   *this = iproxy;
// }
...
//
// const PivarskiCandidateQualityProxy& PivarskiCandidateQualityProxy::operator=( const PivarskiCandidateQualityProxy& iproxy )
// {
//   if( this != &iproxy ) {
...
#endif
void
PivarskiCandidateQualityProxy< H >::invalidateCache()
{
   if ( 0 != m_ptrTable ) {
      (*m_ptrTable).eraseAll() ;
   }
...
template < DBCandidate::Hypo H >
#endif
const typename PivarskiCandidateQualityProxy< H >::value_type*
PivarskiCandidateQualityProxy< H >::faultHandler( const Record& iRecord,
						const DataKey& iKey )
{
   ...
   // the corresponding PivarskiHelix objects have the same identifier.
   ...
   for( ; helixItr != helixEnd ; ++helixItr )
   {
	    ...
	    TRSubdetectorLists::HitTypes( j ) ) )
	 {
      ...
      PivarskiCandidateQuality< H >* tmp = new PivarskiCandidateQuality< H >(
                  ( *helixItr )->identifier(),
                  ( *helixItr )->chisq(),
                  ndof,
...
//void
//PivarskiCandidateQualityProxy::boundMethod( const Record& iRecord )
//{

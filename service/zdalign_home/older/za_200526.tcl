...
hbook file ../rzn/za_200526_iter2.rzn
hbook init

run_file $env(C3_SCRIPTS)/getNewestConstants.tcl
run_file $env(C3_SCRIPTS)/exclude_constants_streams.tcl
exclude_constants_streams {drdriftdatav2 drt0card drt0channelv2 drt0crate drt0global drt0hvcard zddriftdata}
...
source_format sel DRt0channelFileSourceFormat
...
file in /cdat/sol191/disk1/cleo-c/r200526.bin event beginrun startrun endrun

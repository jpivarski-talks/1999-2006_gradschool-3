...
// $Id: KalmanCandidateQualityProxy.cc,v 1.11 2003/07/25 23:34:53 mccann Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanCandidateQualityProxy.cc,v 1.11 2003/07/25 23:34:53 mccann Exp $";

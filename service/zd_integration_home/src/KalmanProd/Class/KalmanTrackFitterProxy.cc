...
// $Id: KalmanTrackFitterProxy.cc,v 1.17 2003/07/25 23:34:50 mccann Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanTrackFitterProxy.cc,v 1.17 2003/07/25 23:34:50 mccann Exp $";

...
// $Id: KalmanProd.cc,v 1.15 2003/04/17 17:05:05 bkh Exp $
//
// Revision history
//
// $Log: KalmanProd.cc,v $
...
static const char* const kIdString  = "$Id: KalmanProd.cc,v 1.15 2003/04/17 17:05:05 bkh Exp $";
...
//       UsageTag() );
   ...
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kElectron > >,
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kMuon > >,
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory<KalmanFitZDHitLatticeProxy<DBCandidate::kChargedPion> >,
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory<KalmanFitZDHitLatticeProxy<DBCandidate::kChargedKaon> >,
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kProton > >,
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory<
      KalmanFitZDHitLatticeProxy< DBCandidate::kExitElectron > > , 
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kExitMuon > >,
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kExitPion > >,
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kExitKaon > >,
      UsageTag() );
   registerProxyFactory(
      Stream::kEvent,
      new ProxyFactory< KalmanFitZDHitLatticeProxy<DBCandidate::kExitProton> >,
      UsageTag() );
...
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kElectron > > ;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kMuon > >;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kChargedPion > >;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kChargedKaon > >;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kProton > >;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kExitElectron > > ;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kExitMuon > >;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kExitPion > >;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kExitKaon > >;
template class
ProxyFactory< KalmanFitZDHitLatticeProxy< DBCandidate::kExitProton > >;

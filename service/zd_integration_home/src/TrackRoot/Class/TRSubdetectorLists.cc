...
// $Id: TRSubdetectorLists.cc,v 1.3 2003/07/25 23:17:09 mccann Exp $
//
// Revision history
//
// $Log: TRSubdetectorLists.cc,v $
// Revision 1.3  2003/07/25 23:17:09  mccann
...
static const char* const kIdString  = "$Id: TRSubdetectorLists.cc,v 1.3 2003/07/25 23:17:09 mccann Exp $";
...
[ TRSubdetectorLists::kNumberOfHitTypes ] =
{
   ...
   { 0,    // PT (not there)
     ...
     0,    // SVZ (not there)
     0,    // DR2 (not there)
     7,    // DR axial (layers 7-22 [16 layers]
     23,   // DR stereo (layers 23-53 [31 layers]
     0,    // VD Cathode (not there)
     54,   // DR cathode (1)
     1,    // ZD (layers 1-6 [6 layers])
     1 }   // Entire (starts at one)
} ;
...
[ TRSubdetectorLists::kNumberOfHitTypes ] =
{
   ...
   { 0,    // PT (not there)
     ...
     0,    // SVZ (not there)
     0,    // DR2 (not there)
     16,   // DR axial (layers 7-22 [16 layers]
     31,   // DR stereo (layers 23-53 [31 layers]
     0,    // VD Cathode (not there)
     1,    // DR cathode (1)
     6,    // ZD (layers 1-6 [6 layers])
     54 }  // Entire (starts at one)

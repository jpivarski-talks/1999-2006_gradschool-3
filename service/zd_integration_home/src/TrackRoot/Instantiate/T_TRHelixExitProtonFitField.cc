...
// $Id: T_TRHelixExitProtonFitField.cc,v 1.2 2000/01/05 19:08:08 cdj Exp $
//
// Revision history
//
// $Log: T_TRHelixExitProtonFitField.cc,v $
// Revision 1.2  2000/01/05 19:08:08  cdj
...
INSTANTIATE_HELIX_FIELD( DBCandidate::kExitProton, ExitProton )

...
// $Id: T_TRHelixMuonFit.cc,v 1.1.1.1 1998/07/20 21:16:10 marsh Exp $
//
// Revision history
//
// $Log: T_TRHelixMuonFit.cc,v $
...
//const Stream::Type& TRHelixMuonFit::kStream = Stream::kEvent ;
//const IfdStrKey TRHelixMuonFit::kAnchor( "" ) ;

#if ( defined(PRAGMA_TEMPLATE_INSTANTIATION_BUG) && defined(__DECCXX) )
// for AXP
#pragma define_template TRHelixCandidateFit< DBCandidate::kMuon >
#else
template class TRHelixCandidateFit< DBCandidate::kMuon > ;

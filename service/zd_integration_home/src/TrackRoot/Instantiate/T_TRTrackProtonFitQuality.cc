...
// 
// Description: Instantiate TRTrackCandidateFitQuality< kProton >
//
// Implimentation:
...
// $Id: T_TRTrackProtonFitQuality.cc,v 1.1 1998/12/18 19:37:18 marsh Exp $
//
// Revision history
//
// $Log: T_TRTrackProtonFitQuality.cc,v $
...
// for AXP
#pragma define_template TRTrackCandidateFitQuality< DBCandidate::kProton >
#else
template class TRTrackCandidateFitQuality< DBCandidate::kProton > ;

...
// $Id: DoitSVZLatticeProxy.cc,v 1.2 2003/04/16 18:12:37 bkh Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: DoitSVZLatticeProxy.cc,v 1.2 2003/04/16 18:12:37 bkh Exp $";

...
// $Id: ManyCalibratedCathodeHitStorageHelper.cc,v 1.1 2000/03/03 15:12:56 lyon Exp $
//
// Revision history
//
// $Log: ManyCalibratedCathodeHitStorageHelper.cc,v $
...
typedef CalibratedCathodeHit _many_element_ ;

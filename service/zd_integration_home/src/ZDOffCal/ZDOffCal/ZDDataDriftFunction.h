#if !defined(ZDOFFCAL_DATADRIFTFUNCTION_H)
#define ZDOFFCAL_DATADRIFTFUNCTION_H
// -*- C++ -*-
//
// Package:     <ZDOffCal>
...
// $Id: ZDDataDriftFunction.h,v 1.1 2003/04/24 18:08:16 huanggs Exp $
//
// Revision history
//
...
public:
  ...
  */
  ...
  ZDDataDriftFunction(ZDOffCalProducer* Producer, ZDDFDataHolder* iDataHolder);
...
#endif /* ZDOFFCAL_DATADRIFTFUNCTION_H */

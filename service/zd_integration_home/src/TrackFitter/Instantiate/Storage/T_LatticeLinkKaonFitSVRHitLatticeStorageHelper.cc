...
//
// Package:     <TrackFitter>
// Module:      LatticeKaonFitSVRHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkKaonFitSVRHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:10 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkKaonFitSVRHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kChargedKaon,Kaon,SVR)

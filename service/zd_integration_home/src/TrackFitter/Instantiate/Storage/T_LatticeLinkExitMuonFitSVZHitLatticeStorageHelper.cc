...
//
// Package:     <TrackFitter>
// Module:      LatticeExitMuonFitSVZHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkExitMuonFitSVZHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:07 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkExitMuonFitSVZHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kExitMuon,ExitMuon,SVZ)

...
//
// Package:     <TrackFitter>
// Module:      LatticePionFitSVZHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkPionFitSVZHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:13 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkPionFitSVZHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kChargedPion,Pion,SVZ)

...
//
// Package:     <TrackFitter>
// Module:      LatticeExitElectronFitDRHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkExitElectronFitDRHitLatticeStorageHelper.cc,v 1.3 2002/06/15 01:59:04 cdj Exp $
//
// Revision history
//
// $Log: T_LatticeLinkExitElectronFitDRHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kExitElectron,ExitElectron,DR)

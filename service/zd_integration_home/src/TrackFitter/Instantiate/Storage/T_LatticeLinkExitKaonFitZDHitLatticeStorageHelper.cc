...
//
// Package:     <TrackFitter>
// Module:      LatticeExitKaonFitZDHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkExitKaonFitZDHitLatticeStorageHelper.cc,v 1.1 2003/04/17 17:03:26 bkh Exp $
//
// Revision history
//
// $Log: T_LatticeLinkExitKaonFitZDHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kExitKaon,ExitKaon,ZD)

...
//
// Package:     <TrackFitter>
// Module:      LatticePionFitZDHitLatticeStorageHelper
// 
...
// $Id: T_LatticeLinkPionFitZDHitLatticeStorageHelper.cc,v 1.1 2003/04/17 17:03:29 bkh Exp $
//
// Revision history
//
// $Log: T_LatticeLinkPionFitZDHitLatticeStorageHelper.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICELINK(DBCandidate::kChargedPion,Pion,ZD)

...
// 
// Description: Template instantiation of FAItem< KaonFitZDHitLattice >
//
// Implementation:
...
// $Id: T_KaonFitZDHitLattice.cc,v 1.1 2003/04/17 17:03:14 bkh Exp $
//
// Revision history
//
// $Log: T_KaonFitZDHitLattice.cc,v $
...
INSTANTIATESTORE_TRACKHITLATTICE(Kaon,ZD)

...
//
// Package:     <package>
// Module:      T_Lattice_TRSeedTrack_CalibratedDRHit
// 
...
// $Id: T_FAItem_SeedTrackDRHitLattice.cc,v 1.3 2000/02/08 18:30:34 lyon Exp $
//
// Revision history
//
// $Log: T_FAItem_SeedTrackDRHitLattice.cc,v $
...
typedef SMLatticeStorageHelper<SeedTrackDRHitLattice>
        SeedTrackDRHitLatticeStorageHelper;
SM_REGISTER_STORAGE( SeedTrackDRHitLatticeStorageHelper );

...
class HISiSensorPlane : public HISiLadderPlane
{
   ...
   public:
	 ...
	 const Meters aSagitta = 0 ) ;
      ...
      virtual void setSagitta( const Meters aSagitta );
	 ...
	 const HIHelix&, HepVector& outputVector ) const ;
      ...
      virtual Meters sagitta() const
      { return m_sagitta ; }

      virtual DABoolean propagateHelix( HIHelix &helixToPropagate,
	KTMoveControl::MoveDirection aDirection=KTMoveControl::kDirectionEither );
   ...
   private:
      ...
      Meters m_sagitta ;
      HepPoint3D m_cylinder_center;
      Hep3Vector m_cylinder_dircos;

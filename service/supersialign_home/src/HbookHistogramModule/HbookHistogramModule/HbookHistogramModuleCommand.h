...
// Revision 1.3  2002/01/25 15:34:14  cdj
// ntuple command can now specify full DataKey as well as buffer size
//
// Revision 1.2  2001/12/20 19:12:20  ajm36
...
class HbookHistogramModuleCommand : public HistogramModuleCommand
{
   ...
   protected:
      ...
      virtual int ntupleHandler();
      int ntupleListHandler();
      int ntupleOutHandler();
   ...
   private:
      ...
      DABoolean setKeyWordArg(const string& iKeyWord, 
                              unsigned int iIndex, 

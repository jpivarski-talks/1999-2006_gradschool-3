...
// Module:      AlignmentPlots_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor AlignmentPlots:
//              creates a new AlignmentPlots instance each time 

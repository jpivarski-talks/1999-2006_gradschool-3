...
//
// $Id: hbook_functions.h,v 1.7 2002/05/06 17:47:42 mccann Exp $
//
// $Log: hbook_functions.h,v $
// Revision 1.7  2002/05/06 17:47:42  mccann
...
// Global Filling
extern void hpak_( const FInteger* pIdentifier, const FReal* pValueArray ); 

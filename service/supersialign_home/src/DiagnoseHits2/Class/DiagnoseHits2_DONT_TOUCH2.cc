...
// Module:      DiagnoseHits2_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor DiagnoseHits2:
//              creates a new DiagnoseHits2 instance each time 

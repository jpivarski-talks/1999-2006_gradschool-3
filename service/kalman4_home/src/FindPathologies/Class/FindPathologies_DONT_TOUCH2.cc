...
// Module:      FindPathologies_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor FindPathologies:
//              creates a new FindPathologies instance each time 
